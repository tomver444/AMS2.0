...
// Type: AMS.ErradjustDBDataSetTableAdapters.TableAdapterManager
...
namespace AMS.ErradjustDBDataSetTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private ErradjustTableAdapter _erradjustTableAdapter;
    ...
    {
      get => this._erradjustTableAdapter;
      set => this._erradjustTableAdapter = value;
    }
    ...
    public IDbConnection Connection
    {
      get
      {
        ...
        return this._erradjustTableAdapter != null && this._erradjustTableAdapter.Connection != null ? (IDbConnection) this._erradjustTableAdapter.Connection : (IDbConnection) null;
      }
    ...
    public int TableAdapterInstanceCount
    {
      get
      {
        ...
        if (this._erradjustTableAdapter != null)
      ...
      List<DataRow> allAddedRows)
    {
      ...
      if (this._erradjustTableAdapter != null)
      {
        DataRow[] realUpdatedRows = this.GetRealUpdatedRows(dataSet.Erradjust.Select((string) null, (string) null, DataViewRowState.ModifiedCurrent), allAddedRows);
        if (realUpdatedRows != null && 0 < realUpdatedRows.Length)
        {
          num += this._erradjustTableAdapter.Update(realUpdatedRows);
    ...
    [DebuggerNonUserCode]
    private int UpdateInsertedRows(ErradjustDBDataSet dataSet, List<DataRow> allAddedRows)
    {
      int num = 0;
      if (this._erradjustTableAdapter != null)
      {
        DataRow[] dataRowArray = dataSet.Erradjust.Select((string) null, (string) null, DataViewRowState.Added);
        if (dataRowArray != null && 0 < dataRowArray.Length)
        {
          num += this._erradjustTableAdapter.Update(dataRowArray);
    ...
    [DebuggerNonUserCode]
    private int UpdateDeletedRows(ErradjustDBDataSet dataSet, List<DataRow> allChangedRows)
    {
      int num = 0;
      if (this._erradjustTableAdapter != null)
      {
        DataRow[] dataRowArray = dataSet.Erradjust.Select((string) null, (string) null, DataViewRowState.Deleted);
        if (dataRowArray != null && 0 < dataRowArray.Length)
        {
          num += this._erradjustTableAdapter.Update(dataRowArray);
    ...
    [DebuggerNonUserCode]
    public virtual int UpdateAll(ErradjustDBDataSet dataSet)
    {
      if (dataSet == null)
        throw new ArgumentNullException(nameof (dataSet));
      if (!dataSet.HasChanges())
        return 0;
      if (this._erradjustTableAdapter != null && !this.MatchTableAdapterConnection((IDbConnection) this._erradjustTableAdapter.Connection))
      ...
      try
      {
        if (this._erradjustTableAdapter != null)
        {
          dictionary.Add((object) this._erradjustTableAdapter, (IDbConnection) this._erradjustTableAdapter.Connection);
          this._erradjustTableAdapter.Connection = (OleDbConnection) connection;
          this._erradjustTableAdapter.Transaction = (OleDbTransaction) dbTransaction;
          if (this._erradjustTableAdapter.Adapter.AcceptChangesDuringUpdate)
          {
            this._erradjustTableAdapter.Adapter.AcceptChangesDuringUpdate = false;
            dataAdapterList.Add((DataAdapter) this._erradjustTableAdapter.Adapter);
          }
        }
      ...
      finally
      {
        ...
        if (this._erradjustTableAdapter != null)
        {
          this._erradjustTableAdapter.Connection = (OleDbConnection) dictionary[(object) this._erradjustTableAdapter];
          this._erradjustTableAdapter.Transaction = (OleDbTransaction) null;
        }
