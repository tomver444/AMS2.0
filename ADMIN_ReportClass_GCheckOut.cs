...
// Type: AMS.ADMIN_ReportClass_GCheckOut
...
namespace AMS
{
  internal class ADMIN_ReportClass_GCheckOut
  {
    ...
    public gcheckout_shl gcheckout_shl1;

    public ADMIN_ReportClass_GCheckOut()
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.gcheckout_shl1 = new gcheckout_shl();
    }

    public gcheckout_shl CHECK_CHECKOUT_MONTHLY(
    ...
    public gcheckout_shl Check_Report_All(
      string para_ToCheck_StartDate,
      string para_ToCheck_EndDate,
      string para_ReportType,
      string para_ReportTitle)
    {
      return this.gcheckout_shl1;
    }

    public gcheckout_shl Check_Report_Individual(
      string para_ToCheck_StartDate,
      string para_ToCheck_EndDate,
      string para_ReportType,
      string para_ReportTitle)
    {
      ((ReportDocument) this.gcheckout_shl1).SetDataSource(ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.tempDataSet.GDSales.DataSet);
      ...
      ((ReportDocument) this.gcheckout_shl1).DataDefinition.FormulaFields[0].Text = "\"" + ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.gDescription + "\"";
      ((ReportDocument) this.gcheckout_shl1).DataDefinition.FormulaFields[1].Text = "\"" + DateTime.Now.ToShortDateString() + " " + DateTime.Now.ToShortTimeString() + "\"";
      ((ReportDocument) this.gcheckout_shl1).DataDefinition.FormulaFields[2].Text = "\"" + ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.gUSERID + "\"";
      switch (para_ReportType)
      {
        case "REPORT DATE":
          if (!para_ReportTitle.Contains("Date Range"))
          {
            ((ReportDocument) this.gcheckout_shl1).DataDefinition.FormulaFields[10].Text = "\"" + para_ToCheck_StartDate + "\"";
            break;
          }
          ((ReportDocument) this.gcheckout_shl1).DataDefinition.FormulaFields[10].Text = "\"" + para_ToCheck_StartDate + " To " + para_ToCheck_EndDate + "\"";
          break;
        case "REPORT YEAR":
          ((ReportDocument) this.gcheckout_shl1).DataDefinition.FormulaFields[10].Text = "\"" + para_ToCheck_StartDate.Substring(0, 4) + "\"";
          break;
        default:
          ((ReportDocument) this.gcheckout_shl1).DataDefinition.FormulaFields[10].Text = "\"" + para_ToCheck_StartDate + " To " + para_ToCheck_EndDate + "\"";
          break;
      }
      ((ReportDocument) this.gcheckout_shl1).DataDefinition.FormulaFields[23].Text = "\"" + Global_Data.sBuildingName + "\"";
      ((ReportDocument) this.gcheckout_shl1).DataDefinition.FormulaFields[24].Text = "\"" + para_ReportTitle + "\"";
      ((ReportDocument) this.gcheckout_shl1).DataDefinition.FormulaFields[25].Text = "\"" + para_ReportType + "\"";
      return this.gcheckout_shl1;
    }
  }
}
