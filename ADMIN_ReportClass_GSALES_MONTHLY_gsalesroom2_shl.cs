...
// Type: AMS.ADMIN_ReportClass_GSALES_MONTHLY_gsalesroom2_shl
...
namespace AMS
{
  internal class ADMIN_ReportClass_GSALES_MONTHLY_gsalesroom2_shl
  {
    ...
    public gsalesroom_shl gsalesroom2_1;

    public ADMIN_ReportClass_GSALES_MONTHLY_gsalesroom2_shl()
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.gsalesroom2_1 = new gsalesroom_shl();
    }

    public gsalesroom_shl CHECK_GSALES_MONTHLY(
    ...
    public gsalesroom_shl Check_Report_All(
      string para_ToCheck_StartDate,
      string para_ToCheck_EndDate,
      string para_ReportType,
      string para_ReportTitle)
    {
      ((ReportDocument) this.gsalesroom2_1).SetDataSource(ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.tempDataSet.GDSales.DataSet);
      ...
      if (ADMIN_ReportClass_GSALES_MONTHLY_gsalesroom2_shl.Temp_MDB_SaveFlag)
      ...
      ((ReportDocument) this.gsalesroom2_1).DataDefinition.FormulaFields[0].Text = "\"" + ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.gDescription + "\"";
      ((ReportDocument) this.gsalesroom2_1).DataDefinition.FormulaFields[1].Text = "\"" + DateTime.Now.ToShortDateString() + " " + DateTime.Now.ToShortTimeString() + "\"";
      ((ReportDocument) this.gsalesroom2_1).DataDefinition.FormulaFields[2].Text = "\"" + ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.gUSERID + "\"";
      switch (para_ReportType)
      {
        case "REPORT DATE":
          if (!para_ReportTitle.Contains("Date Range"))
          {
            ((ReportDocument) this.gsalesroom2_1).DataDefinition.FormulaFields[10].Text = "\"" + para_ToCheck_StartDate + "\"";
            break;
          }
          ((ReportDocument) this.gsalesroom2_1).DataDefinition.FormulaFields[10].Text = "\"" + para_ToCheck_StartDate + " To " + para_ToCheck_EndDate + "\"";
          break;
        case "REPORT YEAR":
          ((ReportDocument) this.gsalesroom2_1).DataDefinition.FormulaFields[10].Text = "\"" + para_ToCheck_StartDate.Substring(0, 4) + "\"";
          break;
        default:
          ((ReportDocument) this.gsalesroom2_1).DataDefinition.FormulaFields[10].Text = "\"" + para_ToCheck_StartDate + " To " + para_ToCheck_EndDate + "\"";
          break;
      }
      ((ReportDocument) this.gsalesroom2_1).DataDefinition.FormulaFields[23].Text = "\"" + Global_Data.sBuildingName + "\"";
      ((ReportDocument) this.gsalesroom2_1).DataDefinition.FormulaFields[24].Text = "\"" + para_ReportTitle + "\"";
      ((ReportDocument) this.gsalesroom2_1).DataDefinition.FormulaFields[25].Text = "\"" + para_ReportType + "\"";
      return this.gsalesroom2_1;
    }

    public gsalesroom_shl Check_Report_Individual(
      string para_ToCheck_StartDate,
      string para_ToCheck_EndDate,
      string para_ReportType,
      string para_ReportTitle)
