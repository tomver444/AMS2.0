...
// Type: AMS.TempDataSetTableAdapters.MLogTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [DataObject(true)]
  public class MLogTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public MLogTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `MLog` (`StaffID`, `LogDate`, `InTime`, `OutTime`, `Update`) VALUES (?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT StaffID, LogDate, InTime, OutTime, [Update] FROM MLog";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.MLogDataTable dataTable)
    {
    ...
    public virtual TempDataSet.MLogDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.MLogDataTable data = new TempDataSet.MLogDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.MLogDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "MLog");
    }
