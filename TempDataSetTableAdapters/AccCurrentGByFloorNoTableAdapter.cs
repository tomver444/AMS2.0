...
// Type: AMS.TempDataSetTableAdapters.AccCurrentGByFloorNoTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class AccCurrentGByFloorNoTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public AccCurrentGByFloorNoTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "AccCurrentGByFloorNo",
        ColumnMappings = {
          {
            "ClientID",
            "ClientID"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `AccCurrentGByFloorNo` (`ClientID`, `ForeName`, `SurName`, `RoomNo`, `CardNo`, `LastPayment`, `ValidStart`, `ValidEnd`, `CheckInDate`, `CheckOutDate`, `RoomStart`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ForeName, SurName, RoomNo, CardNo, LastPayment, ValidStart, ValidEnd, CheckInDate, CheckOutDate, RoomStart FROM AccCurrentGByFloorNo";
    ...
    public virtual int Fill(
      TempDataSet.AccCurrentGByFloorNoDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual TempDataSet.AccCurrentGByFloorNoDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.AccCurrentGByFloorNoDataTable data = new TempDataSet.AccCurrentGByFloorNoDataTable();
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "AccCurrentGByFloorNo");
    }
