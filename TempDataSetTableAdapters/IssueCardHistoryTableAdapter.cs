...
// Type: AMS.TempDataSetTableAdapters.IssueCardHistoryTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  [DataObject(true)]
  public class IssueCardHistoryTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public IssueCardHistoryTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `IssueCardHistory` (`CardNo`, `RoomNo`, `CardType`, `ClientID`, `CardStatus`, `KeyCharge`, `ReaderID`, `RecordDate`, `RecordTime`, `Update`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT CardNo, RoomNo, CardType, ClientID, CardStatus, KeyCharge, ReaderID, RecordDate, RecordTime, [Update] FROM IssueCardHistory";
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Fill(TempDataSet.IssueCardHistoryDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual TempDataSet.IssueCardHistoryDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.IssueCardHistoryDataTable data = new TempDataSet.IssueCardHistoryDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.IssueCardHistoryDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "IssueCardHistory");
    }
