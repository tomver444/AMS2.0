...
// Type: AMS.TempDataSetTableAdapters.AccGuestHistoryTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class AccGuestHistoryTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public AccGuestHistoryTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `AccGuestHistory` (`ClientID`, `ForeName`, `SurName`, `CardNo`, `RoomNo`, `TempBld`, `ReserveRef`, `TransType`, `TransDate`, `TransTime`, `LastPayment`, `CheckInDate`, `RoomStart`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ForeName, SurName, CardNo, RoomNo, TempBld, ReserveRef, TransType, TransDate, TransTime, LastPayment, CheckInDate, RoomStart FROM AccGuestHistory";
    ...
    public virtual int Fill(TempDataSet.AccGuestHistoryDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual TempDataSet.AccGuestHistoryDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.AccGuestHistoryDataTable data = new TempDataSet.AccGuestHistoryDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.AccGuestHistoryDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "AccGuestHistory");
    }
      ...
      DateTime? RoomStart)
    {
      ...
      if (LastPayment.HasValue)
        this.Adapter.InsertCommand.Parameters[10].Value = (object) LastPayment.Value;
      else
        this.Adapter.InsertCommand.Parameters[10].Value = (object) DBNull.Value;
      if (CheckInDate.HasValue)
        this.Adapter.InsertCommand.Parameters[11].Value = (object) CheckInDate.Value;
      else
        this.Adapter.InsertCommand.Parameters[11].Value = (object) DBNull.Value;
      if (RoomStart.HasValue)
        this.Adapter.InsertCommand.Parameters[12].Value = (object) RoomStart.Value;
      else
