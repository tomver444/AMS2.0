...
// Type: AMS.TempDataSetTableAdapters.AccSalesTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class AccSalesTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public AccSalesTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `AccSales` (`TransID`, `ClientID`, `ForeName`, `SurName`, `RoomNo`, `TempBld`, `TempMonth`, `CardNo`, `ReserveRef`, `TransType`, `TransDate`, `ChargeType`, `PreviousAdvance`, `AdvancedPayment`, `Bond`, `RBA`, `Deposit`, `KeyDeposit`, `ExtraCharge`, `RoomCharge`, `BonusClaim`, `GST`, `LastPayment`, `StaffID`, `CheckInDate`, `ContractStart`, `ContractEnd`, `CheckOutDate`, `ValidStart`, `ValidEnd`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public virtual int Fill(TempDataSet.AccSalesDataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual TempDataSet.AccSalesDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.AccSalesDataTable data = new TempDataSet.AccSalesDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.AccSalesDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "AccSales");
    }
