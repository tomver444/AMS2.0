...
// Type: AMS.TempDataSetTableAdapters.GData_TempTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class GData_TempTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public GData_TempTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `GData_Temp` (`ClientID`, `ForeName`, `SurName`, `Description`, `ContractStart`, `ContractEnd`, `CheckInDate`, `CheckOutDate`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ForeName, SurName, Description, ContractStart, ContractEnd, CheckInDate, CheckOutDate FROM GData_Temp";
    ...
    [DebuggerNonUserCode]
    public virtual int Fill(TempDataSet.GData_TempDataTable dataTable)
    {
    ...
    public virtual TempDataSet.GData_TempDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.GData_TempDataTable data = new TempDataSet.GData_TempDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.GData_TempDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "GData_Temp");
    }
      ...
      DateTime? CheckOutDate)
    {
      ...
      if (ContractStart.HasValue)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) ContractStart.Value;
      else
        this.Adapter.InsertCommand.Parameters[4].Value = (object) DBNull.Value;
      if (ContractEnd.HasValue)
        this.Adapter.InsertCommand.Parameters[5].Value = (object) ContractEnd.Value;
      else
