...
// Type: AMS.TempDataSetTableAdapters.GuestRecordDateTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class GuestRecordDateTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public GuestRecordDateTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `GuestRecordDate` (`ClientID`, `RoomNo`, `ContractStart`, `ContractEnd`, `GracePeriod`, `ValidStart`, `ValidEnd`, `CheckInDate`, `CheckOutDate`, `BonusDate`, `RoomStart`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, RoomNo, ContractStart, ContractEnd, GracePeriod, ValidStart, ValidEnd, CheckInDate, CheckOutDate, BonusDate, RoomStart FROM GuestRecordDate";
    ...
    [DebuggerNonUserCode]
    public virtual int Fill(TempDataSet.GuestRecordDateDataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual TempDataSet.GuestRecordDateDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.GuestRecordDateDataTable data = new TempDataSet.GuestRecordDateDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.GuestRecordDateDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "GuestRecordDate");
    }
      ...
      DateTime? RoomStart)
    {
      ...
      if (ContractStart.HasValue)
        this.Adapter.InsertCommand.Parameters[2].Value = (object) ContractStart.Value;
      else
        this.Adapter.InsertCommand.Parameters[2].Value = (object) DBNull.Value;
      if (ContractEnd.HasValue)
        this.Adapter.InsertCommand.Parameters[3].Value = (object) ContractEnd.Value;
      else
        this.Adapter.InsertCommand.Parameters[3].Value = (object) DBNull.Value;
      if (GracePeriod.HasValue)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) GracePeriod.Value;
      else
        this.Adapter.InsertCommand.Parameters[4].Value = (object) DBNull.Value;
      if (ValidStart.HasValue)
        this.Adapter.InsertCommand.Parameters[5].Value = (object) ValidStart.Value;
      else
        this.Adapter.InsertCommand.Parameters[5].Value = (object) DBNull.Value;
      if (ValidEnd.HasValue)
        this.Adapter.InsertCommand.Parameters[6].Value = (object) ValidEnd.Value;
      else
        this.Adapter.InsertCommand.Parameters[6].Value = (object) DBNull.Value;
      if (CheckInDate.HasValue)
        this.Adapter.InsertCommand.Parameters[7].Value = (object) CheckInDate.Value;
      else
        this.Adapter.InsertCommand.Parameters[7].Value = (object) DBNull.Value;
      if (CheckOutDate.HasValue)
        this.Adapter.InsertCommand.Parameters[8].Value = (object) CheckOutDate.Value;
      else
        this.Adapter.InsertCommand.Parameters[8].Value = (object) DBNull.Value;
      if (BonusDate == null)
        this.Adapter.InsertCommand.Parameters[9].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[9].Value = (object) BonusDate;
      if (RoomStart.HasValue)
        this.Adapter.InsertCommand.Parameters[10].Value = (object) RoomStart.Value;
      else
