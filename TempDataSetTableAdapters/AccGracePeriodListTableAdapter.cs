...
// Type: AMS.TempDataSetTableAdapters.AccGracePeriodListTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class AccGracePeriodListTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public AccGracePeriodListTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "AccGracePeriodList",
        ColumnMappings = {
          {
            "ClientID",
            "ClientID"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `AccGracePeriodList` (`ClientID`, `ForeName`, `SurName`, `RoomNo`, `TempBld`, `GracePeriod`, `ValidStart`, `ValidEnd`, `CheckOutDate`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ForeName, SurName, RoomNo, TempBld, GracePeriod, ValidStart, ValidEnd, CheckOutDate FROM AccGracePeriodList";
    ...
    [DebuggerNonUserCode]
    public virtual int Fill(TempDataSet.AccGracePeriodListDataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual TempDataSet.AccGracePeriodListDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.AccGracePeriodListDataTable data = new TempDataSet.AccGracePeriodListDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.AccGracePeriodListDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "AccGracePeriodList");
    }
