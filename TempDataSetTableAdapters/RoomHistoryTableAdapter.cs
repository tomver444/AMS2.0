...
// Type: AMS.TempDataSetTableAdapters.RoomHistoryTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  [DataObject(true)]
  public class RoomHistoryTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public RoomHistoryTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `RoomHistory` (`ClientID`, `ForeName`, `SurName`, `CardNo`, `RoomNo`, `ReserveRef`, `TransType`, `TransDate`, `TransTime`, `LastPayment`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ForeName, SurName, CardNo, RoomNo, ReserveRef, TransType, TransDate, TransTime, LastPayment FROM RoomHistory";
    ...
    public virtual int Fill(TempDataSet.RoomHistoryDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual TempDataSet.RoomHistoryDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.RoomHistoryDataTable data = new TempDataSet.RoomHistoryDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.RoomHistoryDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "RoomHistory");
    }
