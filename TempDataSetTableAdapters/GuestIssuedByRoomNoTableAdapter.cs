...
// Type: AMS.TempDataSetTableAdapters.GuestIssuedByRoomNoTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class GuestIssuedByRoomNoTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public GuestIssuedByRoomNoTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "GuestIssuedByRoomNo",
        ColumnMappings = {
          {
            "CardNo",
            "CardNo"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `GuestIssuedByRoomNo` (`CardNo`, `CardType`, `RoomNo`, `ClientID`, `ForeName`, `SurName`, `CardStatus`, `ReaderID`, `RecordDate`, `RecordTime`, `ValidStart`, `ValidEnd`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT CardNo, CardType, RoomNo, ClientID, ForeName, SurName, CardStatus, ReaderID, RecordDate, RecordTime, ValidStart, ValidEnd FROM GuestIssuedByRoomNo";
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.GuestIssuedByRoomNoDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual TempDataSet.GuestIssuedByRoomNoDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.GuestIssuedByRoomNoDataTable data = new TempDataSet.GuestIssuedByRoomNoDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.GuestIssuedByRoomNoDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "GuestIssuedByRoomNo");
    }
      ...
      DateTime? ValidEnd)
    {
      ...
      if (CardType == null)
        ...
        this.Adapter.InsertCommand.Parameters[1].Value = (object) CardType;
      if (RoomNo == null)
      ...
      if (CardStatus.HasValue)
        this.Adapter.InsertCommand.Parameters[6].Value = (object) CardStatus.Value;
      else
        this.Adapter.InsertCommand.Parameters[6].Value = (object) DBNull.Value;
      if (ReaderID == null)
        this.Adapter.InsertCommand.Parameters[7].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[7].Value = (object) ReaderID;
      if (RecordDate.HasValue)
        this.Adapter.InsertCommand.Parameters[8].Value = (object) RecordDate.Value;
      else
        this.Adapter.InsertCommand.Parameters[8].Value = (object) DBNull.Value;
      if (RecordTime == null)
        this.Adapter.InsertCommand.Parameters[9].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[9].Value = (object) RecordTime;
      if (ValidStart.HasValue)
        this.Adapter.InsertCommand.Parameters[10].Value = (object) ValidStart.Value;
      else
        this.Adapter.InsertCommand.Parameters[10].Value = (object) DBNull.Value;
      if (ValidEnd.HasValue)
        this.Adapter.InsertCommand.Parameters[11].Value = (object) ValidEnd.Value;
      else
