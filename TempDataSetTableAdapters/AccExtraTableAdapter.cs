...
// Type: AMS.TempDataSetTableAdapters.AccExtraTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class AccExtraTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public AccExtraTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `AccExtra` (`RoomNo`, `ReceiptID`, `ClientID`, `TempBld`, `ExDescription`, `ExtraCharge`, `TransType`, `TransDate`, `TransTime`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, ReceiptID, ClientID, TempBld, ExDescription, ExtraCharge, TransType, TransDate, TransTime FROM AccExtra";
    ...
    public virtual int Fill(TempDataSet.AccExtraDataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual TempDataSet.AccExtraDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.AccExtraDataTable data = new TempDataSet.AccExtraDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.AccExtraDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "AccExtra");
    }
      ...
      string TransTime)
    {
      ...
      if (ReceiptID.HasValue)
        this.Adapter.InsertCommand.Parameters[1].Value = (object) ReceiptID.Value;
      else
      ...
      if (ExDescription == null)
        ...
        this.Adapter.InsertCommand.Parameters[4].Value = (object) ExDescription;
      if (ExtraCharge.HasValue)
        this.Adapter.InsertCommand.Parameters[5].Value = (object) ExtraCharge.Value;
      else
