...
// Type: AMS.TempDataSetTableAdapters.GuestIssuedByGuestIDTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  [DataObject(true)]
  public class GuestIssuedByGuestIDTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public GuestIssuedByGuestIDTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "GuestIssuedByGuestID",
        ColumnMappings = {
          {
            "CardNo",
            "CardNo"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `GuestIssuedByGuestID` (`CardNo`, `CardType`, `RoomNo`, `ClientID`, `ForeName`, `SurName`, `CardStatus`, `ReaderID`, `RecordDate`, `RecordTime`, `ValidStart`, `ValidEnd`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT CardNo, CardType, RoomNo, ClientID, ForeName, SurName, CardStatus, ReaderID, RecordDate, RecordTime, ValidStart, ValidEnd FROM GuestIssuedByGuestID";
    ...
    public virtual int Fill(
      TempDataSet.GuestIssuedByGuestIDDataTable dataTable)
    {
    ...
    public virtual TempDataSet.GuestIssuedByGuestIDDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.GuestIssuedByGuestIDDataTable data = new TempDataSet.GuestIssuedByGuestIDDataTable();
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "GuestIssuedByGuestID");
    }
