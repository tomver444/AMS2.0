...
// Type: AMS.TempDataSetTableAdapters.GracePeriodListTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class GracePeriodListTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public GracePeriodListTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `GracePeriodList` (`ClientID`, `ForeName`, `SurName`, `RoomNo`, `GracePeriod`, `ValidStart`, `ValidEnd`, `CheckOutDate`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ForeName, SurName, RoomNo, GracePeriod, ValidStart, ValidEnd, CheckOutDate FROM GracePeriodList";
    ...
    [DebuggerNonUserCode]
    public virtual int Fill(TempDataSet.GracePeriodListDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual TempDataSet.GracePeriodListDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.GracePeriodListDataTable data = new TempDataSet.GracePeriodListDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.GracePeriodListDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "GracePeriodList");
    }
      ...
      DateTime? CheckOutDate)
    {
      ...
      if (CheckOutDate.HasValue)
        this.Adapter.InsertCommand.Parameters[7].Value = (object) CheckOutDate.Value;
      else
