...
// Type: AMS.TempDataSetTableAdapters.UnLockDoorByRoomNoTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class UnLockDoorByRoomNoTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public UnLockDoorByRoomNoTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "UnLockDoorByRoomNo",
        ColumnMappings = {
          {
            "RoomNo",
            "RoomNo"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `UnLockDoorByRoomNo` (`RoomNo`, `CardNo`, `CardType`, `UnLockSDate`, `UnLockSTime`, `CollectionSDate`, `CollectionSTime`, `ClientID`, `ForeName`, `SurName`, `StaffID`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, CardNo, CardType, UnLockSDate, UnLockSTime, CollectionSDate, CollectionSTime, ClientID, ForeName, SurName, StaffID, ID FROM UnLockDoorByRoomNo";
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Fill(TempDataSet.UnLockDoorByRoomNoDataTable dataTable)
    {
    ...
    public virtual TempDataSet.UnLockDoorByRoomNoDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.UnLockDoorByRoomNoDataTable data = new TempDataSet.UnLockDoorByRoomNoDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.UnLockDoorByRoomNoDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "UnLockDoorByRoomNo");
    }
