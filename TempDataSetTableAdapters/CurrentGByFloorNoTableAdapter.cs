...
// Type: AMS.TempDataSetTableAdapters.CurrentGByFloorNoTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class CurrentGByFloorNoTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public CurrentGByFloorNoTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "CurrentGByFloorNo",
        ColumnMappings = {
          {
            "ClientID",
            "ClientID"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `CurrentGByFloorNo` (`ClientID`, `ForeName`, `SurName`, `RoomNo`, `CardNo`, `LastPayment`, `ValidStart`, `ValidEnd`, `CheckInDate`, `CheckOutDate`, `RoomStart`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ForeName, SurName, RoomNo, CardNo, LastPayment, ValidStart, ValidEnd, CheckInDate, CheckOutDate, RoomStart FROM CurrentGByFloorNo";
    ...
    public virtual int Fill(TempDataSet.CurrentGByFloorNoDataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual TempDataSet.CurrentGByFloorNoDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.CurrentGByFloorNoDataTable data = new TempDataSet.CurrentGByFloorNoDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.CurrentGByFloorNoDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "CurrentGByFloorNo");
    }
