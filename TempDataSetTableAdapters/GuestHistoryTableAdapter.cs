...
// Type: AMS.TempDataSetTableAdapters.GuestHistoryTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class GuestHistoryTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public GuestHistoryTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `GuestHistory` (`ClientID`, `ForeName`, `SurName`, `CardNo`, `RoomNo`, `ReserveRef`, `TransType`, `TransDate`, `TransTime`, `LastPayment`, `CheckInDate`, `RoomStart`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ForeName, SurName, CardNo, RoomNo, ReserveRef, TransType, TransDate, TransTime, LastPayment, CheckInDate, RoomStart FROM GuestHistory";
    ...
    public virtual int Fill(TempDataSet.GuestHistoryDataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual TempDataSet.GuestHistoryDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.GuestHistoryDataTable data = new TempDataSet.GuestHistoryDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.GuestHistoryDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "GuestHistory");
    }
      ...
      DateTime? RoomStart)
    {
      ...
      if (CheckInDate.HasValue)
        this.Adapter.InsertCommand.Parameters[10].Value = (object) CheckInDate.Value;
      else
