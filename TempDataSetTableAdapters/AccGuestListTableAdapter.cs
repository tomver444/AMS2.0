...
// Type: AMS.TempDataSetTableAdapters.AccGuestListTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  [DataObject(true)]
  public class AccGuestListTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public AccGuestListTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `AccGuestList` (`ClientID`, `ClientType`, `ForeName`, `SurName`, `TempBld`, `Sex`, `Identity`, `Nationality`, `Address`, `Country`, `Contact`, `Update`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ClientType, ForeName, SurName, TempBld, Sex, [Identity], Nationality, Address, Country, Contact, [Update] FROM AccGuestList";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.AccGuestListDataTable dataTable)
    {
    ...
    public virtual TempDataSet.AccGuestListDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.AccGuestListDataTable data = new TempDataSet.AccGuestListDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.AccGuestListDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "AccGuestList");
    }
