...
// Type: AMS.TempDataSetTableAdapters.AccGuestRecordDateTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class AccGuestRecordDateTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public AccGuestRecordDateTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "AccGuestRecordDate",
        ColumnMappings = {
          {
            "ClientID",
            "ClientID"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `AccGuestRecordDate` (`ClientID`, `RoomNo`, `TempBld`, `ContractStart`, `ContractEnd`, `GracePeriod`, `ValidStart`, `ValidEnd`, `CheckInDate`, `CheckOutDate`, `BonusDate`, `RoomStart`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, RoomNo, TempBld, ContractStart, ContractEnd, GracePeriod, ValidStart, ValidEnd, CheckInDate, CheckOutDate, BonusDate, RoomStart FROM AccGuestRecordDate";
    ...
    public virtual int Fill(TempDataSet.AccGuestRecordDateDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual TempDataSet.AccGuestRecordDateDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.AccGuestRecordDateDataTable data = new TempDataSet.AccGuestRecordDateDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.AccGuestRecordDateDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "AccGuestRecordDate");
    }
      ...
      DateTime? RoomStart)
    {
      ...
      if (ContractStart.HasValue)
        this.Adapter.InsertCommand.Parameters[3].Value = (object) ContractStart.Value;
      else
        this.Adapter.InsertCommand.Parameters[3].Value = (object) DBNull.Value;
      if (ContractEnd.HasValue)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) ContractEnd.Value;
      else
        this.Adapter.InsertCommand.Parameters[4].Value = (object) DBNull.Value;
      if (GracePeriod.HasValue)
        this.Adapter.InsertCommand.Parameters[5].Value = (object) GracePeriod.Value;
      else
        this.Adapter.InsertCommand.Parameters[5].Value = (object) DBNull.Value;
      if (ValidStart.HasValue)
        this.Adapter.InsertCommand.Parameters[6].Value = (object) ValidStart.Value;
      else
        this.Adapter.InsertCommand.Parameters[6].Value = (object) DBNull.Value;
      if (ValidEnd.HasValue)
        this.Adapter.InsertCommand.Parameters[7].Value = (object) ValidEnd.Value;
      else
        this.Adapter.InsertCommand.Parameters[7].Value = (object) DBNull.Value;
      if (CheckInDate.HasValue)
        this.Adapter.InsertCommand.Parameters[8].Value = (object) CheckInDate.Value;
      else
        this.Adapter.InsertCommand.Parameters[8].Value = (object) DBNull.Value;
      if (CheckOutDate.HasValue)
        this.Adapter.InsertCommand.Parameters[9].Value = (object) CheckOutDate.Value;
      else
        this.Adapter.InsertCommand.Parameters[9].Value = (object) DBNull.Value;
      if (BonusDate == null)
        this.Adapter.InsertCommand.Parameters[10].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[10].Value = (object) BonusDate;
      if (RoomStart.HasValue)
        this.Adapter.InsertCommand.Parameters[11].Value = (object) RoomStart.Value;
      else
