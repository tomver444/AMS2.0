...
// Type: AMS.TempDataSetTableAdapters.UploadDataTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class UploadDataTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public UploadDataTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `UploadData` (`RoomNo`, `CardNo`, `CardType`, `UnlockSDate`, `UnlockSTime`, `CollectionSDate`, `CollectionSTime`, `ClientID`, `ForeName`, `SurName`, `StaffID`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, CardNo, CardType, UnlockSDate, UnlockSTime, CollectionSDate, CollectionSTime, ClientID, ForeName, SurName, StaffID FROM UploadData";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.UploadDataDataTable dataTable)
    {
    ...
    public virtual TempDataSet.UploadDataDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.UploadDataDataTable data = new TempDataSet.UploadDataDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.UploadDataDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "UploadData");
    }
