...
// Type: AMS.TempDataSetTableAdapters.DTransactionsTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class DTransactionsTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public DTransactionsTableAdapter() => this.ClearBeforeFill = true;
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.DTransactionsDataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual TempDataSet.DTransactionsDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.DTransactionsDataTable data = new TempDataSet.DTransactionsDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.DTransactionsDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "DTransactions");
    }
      ...
      bool Update)
    {
      ...
      this.Adapter.InsertCommand.Parameters[33].Value = (object) Update;
