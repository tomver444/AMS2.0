...
// Type: AMS.TempDataSetTableAdapters.AccRoomInformationTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class AccRoomInformationTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public AccRoomInformationTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "AccRoomInformation",
        ColumnMappings = {
          {
            "RoomNo",
            "RoomNo"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `AccRoomInformation` (`RoomNo`, `RmDescription`, `Description`, `ClientID`, `BuildingNo`, `FloorNo`, `DailyRate`, `WeeklyRate`, `MonthlyRate`, `DailyRate2`, `WeeklyRate2`, `MonthlyRate2`, `IssuedCard`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, RmDescription, Description, ClientID, BuildingNo, FloorNo, DailyRate, WeeklyRate, MonthlyRate, DailyRate2, WeeklyRate2, MonthlyRate2, IssuedCard FROM AccRoomInformation";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.AccRoomInformationDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual TempDataSet.AccRoomInformationDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.AccRoomInformationDataTable data = new TempDataSet.AccRoomInformationDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.AccRoomInformationDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "AccRoomInformation");
    }
