...
// Type: AMS.TempDataSetTableAdapters.DetailGuestIssuedTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  [DataObject(true)]
  public class DetailGuestIssuedTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public DetailGuestIssuedTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "DetailGuestIssued",
        ColumnMappings = {
          {
            "CardNo",
            "CardNo"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `DetailGuestIssued` (`CardNo`, `CardType`, `RoomNo`, `ClientID`, `ForeName`, `SurName`, `CardStatus`, `ReaderID`, `RecordDate`, `RecordTime`, `ValidStart`, `ValidEnd`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT CardNo, CardType, RoomNo, ClientID, ForeName, SurName, CardStatus, ReaderID, RecordDate, RecordTime, ValidStart, ValidEnd FROM DetailGuestIssued";
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.DetailGuestIssuedDataTable dataTable)
    {
    ...
    public virtual TempDataSet.DetailGuestIssuedDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.DetailGuestIssuedDataTable data = new TempDataSet.DetailGuestIssuedDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.DetailGuestIssuedDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "DetailGuestIssued");
    }
