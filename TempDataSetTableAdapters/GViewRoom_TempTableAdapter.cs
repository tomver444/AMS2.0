...
// Type: AMS.TempDataSetTableAdapters.GViewRoom_TempTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  [DataObject(true)]
  public class GViewRoom_TempTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public GViewRoom_TempTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM GViewRoom_Temp\r\nWHERE  (ClientID = ?)";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `GViewRoom_Temp` (`ClientID`, `ForeName`, `SurName`, `Description`, `StartDate`, `EndDate`) VALUES (?, ?, ?, ?, ?, ?)";
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE GViewRoom_Temp\r\nSET        ClientID = ?, ForeName = ?, SurName = ?, Description = ?, StartDate = ?, EndDate = ?\r\nWHERE  (ClientID = ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ForeName, SurName, Description, StartDate, EndDate FROM GViewRoom_Temp";
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.GViewRoom_TempDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual TempDataSet.GViewRoom_TempDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.GViewRoom_TempDataTable data = new TempDataSet.GViewRoom_TempDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.GViewRoom_TempDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "GViewRoom_Temp");
    }
      ...
      DateTime? EndDate)
    {
      ...
      if (StartDate.HasValue)
        this.Adapter.InsertCommand.Parameters[4].Value = (object) StartDate.Value;
      else
        this.Adapter.InsertCommand.Parameters[4].Value = (object) DBNull.Value;
      if (EndDate.HasValue)
        this.Adapter.InsertCommand.Parameters[5].Value = (object) EndDate.Value;
      else
      ...
      string Original_ClientID)
    {
      ...
      if (ForeName == null)
        ...
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) ForeName;
      if (SurName == null)
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) SurName;
      if (Description == null)
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) Description;
      if (StartDate.HasValue)
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) StartDate.Value;
      else
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) DBNull.Value;
      if (EndDate.HasValue)
        this.Adapter.UpdateCommand.Parameters[5].Value = (object) EndDate.Value;
      else
        this.Adapter.UpdateCommand.Parameters[5].Value = (object) DBNull.Value;
      if (Original_ClientID == null)
        this.Adapter.UpdateCommand.Parameters[6].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[6].Value = (object) Original_ClientID;
