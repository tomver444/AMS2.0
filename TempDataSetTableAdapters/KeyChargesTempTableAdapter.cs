...
// Type: AMS.TempDataSetTableAdapters.KeyChargesTempTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  [DataObject(true)]
  public class KeyChargesTempTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public KeyChargesTempTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `KeyChargesTemp` (`BuildingNo`, `KeyDeposit`, `SpareKeyCharge`, `StaffID`, `Update`) VALUES (?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT BuildingNo, KeyDeposit, SpareKeyCharge, StaffID, [Update] FROM KeyChargesTemp";
    ...
    [DebuggerNonUserCode]
    public virtual int Fill(TempDataSet.KeyChargesTempDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual TempDataSet.KeyChargesTempDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.KeyChargesTempDataTable data = new TempDataSet.KeyChargesTempDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.KeyChargesTempDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "KeyChargesTemp");
    }
