...
// Type: AMS.TempDataSetTableAdapters.AccRoomDetailTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class AccRoomDetailTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public AccRoomDetailTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `AccRoomDetail` (`RoomNo`, `TempBld`, `RmDescription`, `Description`, `ClientID`, `ForeName`, `SurName`, `StartDate`, `EndDate`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, TempBld, RmDescription, Description, ClientID, ForeName, SurName, StartDate, EndDate FROM AccRoomDetail";
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Fill(TempDataSet.AccRoomDetailDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual TempDataSet.AccRoomDetailDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.AccRoomDetailDataTable data = new TempDataSet.AccRoomDetailDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.AccRoomDetailDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "AccRoomDetail");
    }
      ...
      DateTime? EndDate)
    {
      ...
      if (TempBld == null)
        ...
        this.Adapter.InsertCommand.Parameters[1].Value = (object) TempBld;
      if (RmDescription == null)
        this.Adapter.InsertCommand.Parameters[2].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[2].Value = (object) RmDescription;
      if (Description == null)
      ...
      if (ForeName == null)
        ...
        this.Adapter.InsertCommand.Parameters[5].Value = (object) ForeName;
      if (SurName == null)
        this.Adapter.InsertCommand.Parameters[6].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[6].Value = (object) SurName;
