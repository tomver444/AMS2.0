...
// Type: AMS.TempDataSetTableAdapters.UnlockDoorHistoryTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class UnlockDoorHistoryTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public UnlockDoorHistoryTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "UnlockDoorHistory",
        ColumnMappings = {
          {
            "RoomNo",
            "RoomNo"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `UnlockDoorHistory` (`RoomNo`, `CardNo`, `CardType`, `UnLockSDate`, `UnLockSTime`, `CollectionSDate`, `CollectionSTime`, `ClientID`, `ForeName`, `SurName`, `StaffID`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, CardNo, CardType, UnLockSDate, UnLockSTime, CollectionSDate, CollectionSTime, ClientID, ForeName, SurName, StaffID, ID FROM UnlockDoorHistory";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.UnlockDoorHistoryDataTable dataTable)
    {
    ...
    public virtual TempDataSet.UnlockDoorHistoryDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.UnlockDoorHistoryDataTable data = new TempDataSet.UnlockDoorHistoryDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.UnlockDoorHistoryDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "UnlockDoorHistory");
    }
