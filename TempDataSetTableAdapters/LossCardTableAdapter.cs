...
// Type: AMS.TempDataSetTableAdapters.LossCardTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class LossCardTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public LossCardTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `LossCard` (`CardNo`, `RoomNo`, `CardType`, `ClientID`, `CardStatus`, `KeyCharge`, `ReaderID`, `RecordDate`, `RecordTime`, `Update`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT CardNo, RoomNo, CardType, ClientID, CardStatus, KeyCharge, ReaderID, RecordDate, RecordTime, [Update] FROM LossCard";
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Fill(TempDataSet.LossCardDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual TempDataSet.LossCardDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.LossCardDataTable data = new TempDataSet.LossCardDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.LossCardDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "LossCard");
    }
