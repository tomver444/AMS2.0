...
// Type: AMS.TempDataSetTableAdapters.GuestIssuedByFloorNoTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class GuestIssuedByFloorNoTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public GuestIssuedByFloorNoTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "GuestIssuedByFloorNo",
        ColumnMappings = {
          {
            "CardNo",
            "CardNo"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `GuestIssuedByFloorNo` (`CardNo`, `CardType`, `RoomNo`, `ClientID`, `ForeName`, `SurName`, `CardStatus`, `ReaderID`, `RecordDate`, `RecordTime`, `ValidStart`, `ValidEnd`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT CardNo, CardType, RoomNo, ClientID, ForeName, SurName, CardStatus, ReaderID, RecordDate, RecordTime, ValidStart, ValidEnd FROM GuestIssuedByFloorNo";
    ...
    public virtual int Fill(
      TempDataSet.GuestIssuedByFloorNoDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual TempDataSet.GuestIssuedByFloorNoDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.GuestIssuedByFloorNoDataTable data = new TempDataSet.GuestIssuedByFloorNoDataTable();
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "GuestIssuedByFloorNo");
    }
