...
// Type: AMS.TempDataSetTableAdapters.CurrentGInfoTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class CurrentGInfoTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public CurrentGInfoTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `CurrentGInfo` (`ClientID`, `ForeName`, `SurName`, `RoomNo`, `Sex`, `Identity`, `Nationality`, `Address`, `Country`, `Contact`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ForeName, SurName, RoomNo, Sex, [Identity], Nationality, Address, Country, Contact FROM CurrentGInfo";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.CurrentGInfoDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual TempDataSet.CurrentGInfoDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.CurrentGInfoDataTable data = new TempDataSet.CurrentGInfoDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.CurrentGInfoDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "CurrentGInfo");
    }
