...
// Type: AMS.TempDataSetTableAdapters.GuestAccountTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  [DataObject(true)]
  public class GuestAccountTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public GuestAccountTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `GuestAccount` (`ClientID`, `ForeName`, `SurName`, `RoomNo`, `CardNo`, `Deposit`, `Bond`, `ChargeType`, `LastPayment`, `AmountPaid`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ForeName, SurName, RoomNo, CardNo, Deposit, Bond, ChargeType, LastPayment, AmountPaid FROM GuestAccount";
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.GuestAccountDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual TempDataSet.GuestAccountDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.GuestAccountDataTable data = new TempDataSet.GuestAccountDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.GuestAccountDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "GuestAccount");
    }
      ...
      Decimal? AmountPaid)
    {
      ...
      if (Bond.HasValue)
        this.Adapter.InsertCommand.Parameters[6].Value = (object) Bond.Value;
      else
        this.Adapter.InsertCommand.Parameters[6].Value = (object) DBNull.Value;
      if (ChargeType == null)
        this.Adapter.InsertCommand.Parameters[7].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[7].Value = (object) ChargeType;
      if (LastPayment.HasValue)
        this.Adapter.InsertCommand.Parameters[8].Value = (object) LastPayment.Value;
      else
        this.Adapter.InsertCommand.Parameters[8].Value = (object) DBNull.Value;
      if (AmountPaid.HasValue)
        this.Adapter.InsertCommand.Parameters[9].Value = (object) AmountPaid.Value;
      else
