...
// Type: AMS.TempDataSetTableAdapters.AccGInfo_TempTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class AccGInfo_TempTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public AccGInfo_TempTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `AccGInfo_Temp` (`ClientID`, `ForeName`, `SurName`, `RoomNo`, `CardNo`, `ValidStart`, `ValidEnd`) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ForeName, SurName, RoomNo, CardNo, ValidStart, ValidEnd FROM AccGInfo_Temp";
    ...
    [DebuggerNonUserCode]
    public virtual int Fill(TempDataSet.AccGInfo_TempDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual TempDataSet.AccGInfo_TempDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.AccGInfo_TempDataTable data = new TempDataSet.AccGInfo_TempDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.AccGInfo_TempDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "AccGInfo_Temp");
    }
