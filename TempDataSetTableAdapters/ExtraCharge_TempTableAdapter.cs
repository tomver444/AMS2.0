...
// Type: AMS.TempDataSetTableAdapters.ExtraCharge_TempTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  public class ExtraCharge_TempTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public ExtraCharge_TempTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `ExtraCharge_Temp` (`ReceiptID`, `ClientID`, `ExDescription`, `ExtraCharge`) VALUES (?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ReceiptID, ClientID, ExDescription, ExtraCharge FROM ExtraCharge_Temp";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.ExtraCharge_TempDataTable dataTable)
    {
    ...
    public virtual TempDataSet.ExtraCharge_TempDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.ExtraCharge_TempDataTable data = new TempDataSet.ExtraCharge_TempDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.ExtraCharge_TempDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "ExtraCharge_Temp");
    }
