...
// Type: AMS.TempDataSetTableAdapters.AccIssuedCardHistoryTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [DataObject(true)]
  public class AccIssuedCardHistoryTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public AccIssuedCardHistoryTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "AccIssuedCardHistory",
        ColumnMappings = {
          {
            "CardNo",
            "CardNo"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `AccIssuedCardHistory` (`CardNo`, `RoomNo`, `CardType`, `ClientID`, `CardStatus`, `KeyCharge`, `TempBld`, `ReaderID`, `RecordDate`, `RecordTime`, `Update`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT CardNo, RoomNo, CardType, ClientID, CardStatus, KeyCharge, TempBld, ReaderID, RecordDate, RecordTime, [Update] FROM AccIssuedCardHistory";
    ...
    public virtual int Fill(
      TempDataSet.AccIssuedCardHistoryDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual TempDataSet.AccIssuedCardHistoryDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.AccIssuedCardHistoryDataTable data = new TempDataSet.AccIssuedCardHistoryDataTable();
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "AccIssuedCardHistory");
    }
      ...
      bool Update)
    {
      ...
      this.Adapter.InsertCommand.Parameters[10].Value = (object) Update;
