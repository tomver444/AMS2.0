...
// Type: AMS.TempDataSetTableAdapters.GuestListTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class GuestListTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public GuestListTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `GuestList` (`ClientID`, `ClientType`, `ForeName`, `SurName`, `Sex`, `Identity`, `Nationality`, `Address`, `Country`, `Contact`, `Update`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ClientID, ClientType, ForeName, SurName, Sex, [Identity], Nationality, Address, Country, Contact, [Update] FROM GuestList";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(TempDataSet.GuestListDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual TempDataSet.GuestListDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.GuestListDataTable data = new TempDataSet.GuestListDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.GuestListDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "GuestList");
    }
