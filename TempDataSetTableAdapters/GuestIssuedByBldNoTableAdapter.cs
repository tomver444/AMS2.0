...
// Type: AMS.TempDataSetTableAdapters.GuestIssuedByBldNoTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class GuestIssuedByBldNoTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public GuestIssuedByBldNoTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      {
        SourceTable = "Table",
        DataSetTable = "GuestIssuedByBldNo",
        ColumnMappings = {
          {
            "CardNo",
            "CardNo"
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `GuestIssuedByBldNo` (`CardNo`, `CardType`, `RoomNo`, `ClientID`, `ForeName`, `SurName`, `CardStatus`, `ReaderID`, `RecordDate`, `RecordTime`, `ValidStart`, `ValidEnd`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT CardNo, CardType, RoomNo, ClientID, ForeName, SurName, CardStatus, ReaderID, RecordDate, RecordTime, ValidStart, ValidEnd FROM GuestIssuedByBldNo";
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Fill(TempDataSet.GuestIssuedByBldNoDataTable dataTable)
    {
    ...
    public virtual TempDataSet.GuestIssuedByBldNoDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.GuestIssuedByBldNoDataTable data = new TempDataSet.GuestIssuedByBldNoDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(TempDataSet.GuestIssuedByBldNoDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "GuestIssuedByBldNo");
    }
