...
// Type: AMS.TempDataSetTableAdapters.RoomDetailTableAdapter
...
namespace AMS.TempDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class RoomDetailTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public RoomDetailTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM RoomDetail\r\nWHERE  (RoomNo = ?)";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `RoomDetail` (`RoomNo`, `RmDescription`, `Description`, `ClientID`, `ForeName`, `SurName`, `StartDate`, `EndDate`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE RoomDetail\r\nSET        RoomNo = ?, RmDescription = ?, Description = ?, ClientID = ?, ForeName = ?, SurName = ?, StartDate = ?, EndDate = ?\r\nWHERE  (RoomNo = ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, RmDescription, Description, ClientID, ForeName, SurName, StartDate, EndDate FROM RoomDetail";
    ...
    [DebuggerNonUserCode]
    public virtual int Fill(TempDataSet.RoomDetailDataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual TempDataSet.RoomDetailDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      TempDataSet.RoomDetailDataTable data = new TempDataSet.RoomDetailDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(TempDataSet.RoomDetailDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "RoomDetail");
    }
      ...
      string Original_RoomNo)
    {
      ...
      if (ClientID == null)
        ...
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) ClientID;
      if (ForeName == null)
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) ForeName;
      if (SurName == null)
        this.Adapter.UpdateCommand.Parameters[5].Value = (object) DBNull.Value;
      else
        this.Adapter.UpdateCommand.Parameters[5].Value = (object) SurName;
      if (StartDate.HasValue)
      ...
      if (Original_RoomNo == null)
        ...
        this.Adapter.UpdateCommand.Parameters[8].Value = (object) Original_RoomNo;
