...
// Type: AMS.BuildingDB1DataSetTableAdapters.RoomStatusTableAdapter
...
namespace AMS.BuildingDB1DataSetTableAdapters
{
  ...
  public class RoomStatusTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public RoomStatusTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM RoomStatus\r\nWHERE  (RoomNo = ?)";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `RoomStatus` (`RoomNo`, `Status`, `Description`, `RoomType`, `ClientID`, `Condition`, `StartDate`, `EndDate`, `StaffID`, `Update`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, Status, Description, RoomType, ClientID, Condition, StartDate, EndDate, StaffID, [Update] FROM RoomStatus";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(BuildingDB1DataSet.RoomStatusDataTable dataTable)
    {
    ...
    public virtual BuildingDB1DataSet.RoomStatusDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      BuildingDB1DataSet.RoomStatusDataTable data = new BuildingDB1DataSet.RoomStatusDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(BuildingDB1DataSet.RoomStatusDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "RoomStatus");
    }
