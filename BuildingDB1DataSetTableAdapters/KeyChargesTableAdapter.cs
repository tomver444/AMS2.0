...
// Type: AMS.BuildingDB1DataSetTableAdapters.KeyChargesTableAdapter
...
namespace AMS.BuildingDB1DataSetTableAdapters
{
  ...
  public class KeyChargesTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public KeyChargesTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `KeyCharges` (`BuildingNo`, `KeyDeposit`, `SpareKeyCharge`, `StaffID`, `Update`) VALUES (?, ?, ?, ?, ?)";
      ...
      this._adapter.InsertCommand.Parameters.Add(new OleDbParameter("SpareKeyCharge", OleDbType.Currency, 0, ParameterDirection.Input, (byte) 0, (byte) 0, "SpareKeyCharge", DataRowVersion.Current, false, (object) null));
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE KeyCharges\r\nSET        BuildingNo = ?, KeyDeposit = ?, SpareKeyCharge = ?, StaffID = ?, [Update] = ?\r\nWHERE  (BuildingNo = ?)";
      ...
      this._adapter.UpdateCommand.Parameters.Add(new OleDbParameter("SpareKeyCharge", OleDbType.Currency, 0, ParameterDirection.Input, (byte) 19, (byte) 0, "SpareKeyCharge", DataRowVersion.Current, false, (object) null));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT BuildingNo, KeyDeposit, SpareKeyCharge, StaffID, [Update] FROM KeyCharges";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(BuildingDB1DataSet.KeyChargesDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual BuildingDB1DataSet.KeyChargesDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      BuildingDB1DataSet.KeyChargesDataTable data = new BuildingDB1DataSet.KeyChargesDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(BuildingDB1DataSet.KeyChargesDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "KeyCharges");
    }
      ...
      bool Update)
    {
      ...
      if (KeyDeposit.HasValue)
        this.Adapter.InsertCommand.Parameters[1].Value = (object) KeyDeposit.Value;
      else
        this.Adapter.InsertCommand.Parameters[1].Value = (object) DBNull.Value;
      if (SpareKeyCharge.HasValue)
        this.Adapter.InsertCommand.Parameters[2].Value = (object) SpareKeyCharge.Value;
      else
      ...
      string Original_BuildingNo)
    {
      ...
      if (KeyDeposit.HasValue)
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) KeyDeposit.Value;
      else
        this.Adapter.UpdateCommand.Parameters[1].Value = (object) DBNull.Value;
      if (SpareKeyCharge.HasValue)
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) SpareKeyCharge.Value;
      else
