...
// Type: AMS.BuildingDB1DataSetTableAdapters.CardTransTableAdapter
...
namespace AMS.BuildingDB1DataSetTableAdapters
{
  ...
  public class CardTransTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public CardTransTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM CardTrans\r\nWHERE  (TransID = ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT TransID, ClientID, CardNo, CardType, RoomNo, Condition, ReserveRef, OldRoom, PreviousAdvance, AdvancedPayment, Balance, Bond, RBA, Deposit, KeyDeposit, ExtraCharge, ExDescription, RoomCharge, TransType, TransDate, TransTime, ValidStart, ValidEnd, CheckInDate, CheckInTime, CheckOutTime, CheckOutDate, ChargeType, GracePeriod, BonusClaim, GST, LastPayment, StaffID, [Update] FROM CardTrans";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(BuildingDB1DataSet.CardTransDataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual BuildingDB1DataSet.CardTransDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      BuildingDB1DataSet.CardTransDataTable data = new BuildingDB1DataSet.CardTransDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(BuildingDB1DataSet.CardTransDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "CardTrans");
    }
    ...
    {
      this.Adapter.DeleteCommand.Parameters[0].Value = (object) TransID;
      ...
      bool Update)
    {
      ...
      if (ReserveRef == null)
        ...
        this.Adapter.InsertCommand.Parameters[5].Value = (object) ReserveRef;
      if (OldRoom == null)
        this.Adapter.InsertCommand.Parameters[6].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[6].Value = (object) OldRoom;
      if (PreviousAdvance.HasValue)
        this.Adapter.InsertCommand.Parameters[7].Value = (object) PreviousAdvance.Value;
      else
        this.Adapter.InsertCommand.Parameters[7].Value = (object) DBNull.Value;
      if (AdvancedPayment.HasValue)
        this.Adapter.InsertCommand.Parameters[8].Value = (object) AdvancedPayment.Value;
      else
        this.Adapter.InsertCommand.Parameters[8].Value = (object) DBNull.Value;
      if (Balance.HasValue)
        this.Adapter.InsertCommand.Parameters[9].Value = (object) Balance.Value;
      else
        this.Adapter.InsertCommand.Parameters[9].Value = (object) DBNull.Value;
      if (Bond.HasValue)
        this.Adapter.InsertCommand.Parameters[10].Value = (object) Bond.Value;
      else
        this.Adapter.InsertCommand.Parameters[10].Value = (object) DBNull.Value;
      if (RBA.HasValue)
        this.Adapter.InsertCommand.Parameters[11].Value = (object) RBA.Value;
      else
        this.Adapter.InsertCommand.Parameters[11].Value = (object) DBNull.Value;
      if (Deposit.HasValue)
        this.Adapter.InsertCommand.Parameters[12].Value = (object) Deposit.Value;
      else
        this.Adapter.InsertCommand.Parameters[12].Value = (object) DBNull.Value;
      if (KeyDeposit.HasValue)
        this.Adapter.InsertCommand.Parameters[13].Value = (object) KeyDeposit.Value;
      else
        this.Adapter.InsertCommand.Parameters[13].Value = (object) DBNull.Value;
      if (ExtraCharge.HasValue)
        this.Adapter.InsertCommand.Parameters[14].Value = (object) ExtraCharge.Value;
      else
      ...
      if (ExDescription == null)
        ...
        this.Adapter.InsertCommand.Parameters[15].Value = (object) ExDescription;
      if (RoomCharge.HasValue)
        this.Adapter.InsertCommand.Parameters[16].Value = (object) RoomCharge.Value;
      else
      ...
      if (TransType == null)
        ...
        this.Adapter.InsertCommand.Parameters[17].Value = (object) TransType;
      if (TransDate.HasValue)
        this.Adapter.InsertCommand.Parameters[18].Value = (object) TransDate.Value;
      else
      ...
      if (TransTime == null)
        ...
        this.Adapter.InsertCommand.Parameters[19].Value = (object) TransTime;
      if (ValidStart.HasValue)
        this.Adapter.InsertCommand.Parameters[20].Value = (object) ValidStart.Value;
      else
        this.Adapter.InsertCommand.Parameters[20].Value = (object) DBNull.Value;
      if (ValidEnd.HasValue)
        this.Adapter.InsertCommand.Parameters[21].Value = (object) ValidEnd.Value;
      else
        this.Adapter.InsertCommand.Parameters[21].Value = (object) DBNull.Value;
      if (CheckInDate.HasValue)
        this.Adapter.InsertCommand.Parameters[22].Value = (object) CheckInDate.Value;
      else
      ...
      if (CheckInTime == null)
        ...
        this.Adapter.InsertCommand.Parameters[23].Value = (object) CheckInTime;
      if (CheckOutTime == null)
        this.Adapter.InsertCommand.Parameters[24].Value = (object) DBNull.Value;
      else
        this.Adapter.InsertCommand.Parameters[24].Value = (object) CheckOutTime;
      if (CheckOutDate.HasValue)
        this.Adapter.InsertCommand.Parameters[25].Value = (object) CheckOutDate.Value;
      else
      ...
      if (ChargeType == null)
        ...
        this.Adapter.InsertCommand.Parameters[26].Value = (object) ChargeType;
      if (GracePeriod.HasValue)
        this.Adapter.InsertCommand.Parameters[27].Value = (object) GracePeriod.Value;
      else
        this.Adapter.InsertCommand.Parameters[27].Value = (object) DBNull.Value;
      if (BonusClaim.HasValue)
        this.Adapter.InsertCommand.Parameters[28].Value = (object) BonusClaim.Value;
      else
        this.Adapter.InsertCommand.Parameters[28].Value = (object) DBNull.Value;
      if (GST.HasValue)
        this.Adapter.InsertCommand.Parameters[29].Value = (object) GST.Value;
      else
        this.Adapter.InsertCommand.Parameters[29].Value = (object) DBNull.Value;
      if (LastPayment.HasValue)
        this.Adapter.InsertCommand.Parameters[30].Value = (object) LastPayment.Value;
      else
      ...
      if (StaffID == null)
        ...
        this.Adapter.InsertCommand.Parameters[31].Value = (object) StaffID;
      this.Adapter.InsertCommand.Parameters[32].Value = (object) Update;
    ...
    {
      this.Adapter.UpdateCommand.Parameters[0].Value = (object) TransID;
      if (ClientID == null)
      ...
      this.Adapter.UpdateCommand.Parameters[33].Value = (object) Update1;
      this.Adapter.UpdateCommand.Parameters[34].Value = (object) Original_TransID;
    ...
    public virtual int Update(
      ...
      int Original_TransID)
    {
      return this.Update(Original_TransID, ClientID, CardNo, CardType, RoomNo, Condition, ReserveRef, OldRoom, PreviousAdvance, AdvancedPayment, Balance, Bond, RBA, Deposit, KeyDeposit, ExtraCharge, ExDescription, RoomCharge, TransType, TransDate, TransTime, ValidStart, ValidEnd, CheckInDate, CheckInTime, CheckOutTime, CheckOutDate, ChargeType, GracePeriod, BonusClaim, GST, LastPayment, StaffID, Update1, Original_TransID);
    }
  }
}
