...
// Type: AMS.BuildingDB1DataSetTableAdapters.LockedRecordTableAdapter
...
namespace AMS.BuildingDB1DataSetTableAdapters
{
  ...
  [DataObject(true)]
  public class LockedRecordTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public LockedRecordTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `LockedRecord` (`RoomNo`, `CardNo`, `CardType`, `UnlockSDate`, `UnlockSTime`, `CollectionSDate`, `CollectionSTime`, `ClientID`, `ForeName`, `SurName`, `StaffID`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, CardNo, CardType, UnlockSDate, UnlockSTime, CollectionSDate, CollectionSTime, ClientID, ForeName, SurName, StaffID FROM LockedRecord";
    ...
    public virtual int Fill(BuildingDB1DataSet.LockedRecordDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual BuildingDB1DataSet.LockedRecordDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      BuildingDB1DataSet.LockedRecordDataTable data = new BuildingDB1DataSet.LockedRecordDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(BuildingDB1DataSet.LockedRecordDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "LockedRecord");
    }
