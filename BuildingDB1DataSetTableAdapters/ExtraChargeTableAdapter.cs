...
// Type: AMS.BuildingDB1DataSetTableAdapters.ExtraChargeTableAdapter
...
namespace AMS.BuildingDB1DataSetTableAdapters
{
  ...
  public class ExtraChargeTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public ExtraChargeTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `ExtraCharge` (`ReceiptID`, `ClientID`, `ExDescription`, `ExtraCharge`) VALUES (?, ?, ?, ?)";
      ...
      this._adapter.UpdateCommand.CommandText = "UPDATE ExtraCharge\r\nSET          ReceiptID = ?, ClientID = ?, ExDescription = ?, ExtraCharge = ?\r\nWHERE  (ReceiptID = ?)";
      ...
      this._adapter.UpdateCommand.Parameters.Add(new OleDbParameter("ExDescription", OleDbType.WChar, 50, ParameterDirection.Input, (byte) 0, (byte) 0, "ExDescription", DataRowVersion.Current, false, (object) null));
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ReceiptID, ClientID, ExDescription, ExtraCharge FROM ExtraCharge";
    ...
    public virtual int Fill(BuildingDB1DataSet.ExtraChargeDataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual BuildingDB1DataSet.ExtraChargeDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      BuildingDB1DataSet.ExtraChargeDataTable data = new BuildingDB1DataSet.ExtraChargeDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(BuildingDB1DataSet.ExtraChargeDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "ExtraCharge");
    }
      ...
      Decimal? ExtraCharge)
    {
      ...
      if (ExDescription == null)
        ...
        this.Adapter.InsertCommand.Parameters[2].Value = (object) ExDescription;
      if (ExtraCharge.HasValue)
        this.Adapter.InsertCommand.Parameters[3].Value = (object) ExtraCharge.Value;
      else
      ...
      int? Original_ReceiptID)
    {
      ...
      if (ExDescription == null)
        ...
        this.Adapter.UpdateCommand.Parameters[2].Value = (object) ExDescription;
      if (ExtraCharge.HasValue)
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) ExtraCharge.Value;
      else
        this.Adapter.UpdateCommand.Parameters[3].Value = (object) DBNull.Value;
      if (Original_ReceiptID.HasValue)
        this.Adapter.UpdateCommand.Parameters[4].Value = (object) Original_ReceiptID.Value;
      else
