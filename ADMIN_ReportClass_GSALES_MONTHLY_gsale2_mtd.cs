...
// Type: AMS.ADMIN_ReportClass_GSALES_MONTHLY_gsale2_mtd
...
namespace AMS
{
  internal class ADMIN_ReportClass_GSALES_MONTHLY_gsale2_mtd
  {
    ...
    public gsales_MTD_Nov06 gsales_MTD_Nov06_1;

    public ADMIN_ReportClass_GSALES_MONTHLY_gsale2_mtd()
    {
    ...
    private void InitializeComponent()
    {
      ...
      this.gsales_MTD_Nov06_1 = new gsales_MTD_Nov06();
    }

    public gsales_MTD_Nov06 CHECK_GSALES_MONTHLY(
    ...
    public gsales_MTD_Nov06 Check_Report_All(
      string para_ToCheck_StartDate,
      string para_ToCheck_EndDate,
      string para_ReportType,
      string para_ReportTitle)
    {
      ((ReportDocument) this.gsales_MTD_Nov06_1).SetDataSource(ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.tempDataSet.GDSales.DataSet);
      ...
      if (ADMIN_ReportClass_GSALES_MONTHLY_gsale2_mtd.Temp_MDB_SaveFlag)
      ...
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields[0].Text = "\"" + ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.gDescription + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields[1].Text = "\"" + DateTime.Now.ToShortDateString() + " " + DateTime.Now.ToShortTimeString() + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields[2].Text = "\"" + ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.gUSERID + "\"";
      switch (para_ReportType)
      {
        case "REPORT DATE":
          if (!para_ReportTitle.Contains("Date Range"))
          {
            ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields[10].Text = "\"" + para_ToCheck_StartDate + "\"";
            break;
          }
          ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields[10].Text = "\"" + para_ToCheck_StartDate + " To " + para_ToCheck_EndDate + "\"";
          break;
        case "REPORT YEAR":
          ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields[10].Text = "\"" + para_ToCheck_StartDate.Substring(0, 4) + "\"";
          break;
        default:
          ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields[10].Text = "\"" + para_ToCheck_StartDate + " To " + para_ToCheck_EndDate + "\"";
          break;
      }
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields[23].Text = "\"" + Global_Data.sBuildingName + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields[24].Text = "\"" + para_ReportTitle + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields[25].Text = "\"" + para_ReportType + "\"";
      ...
      return this.gsales_MTD_Nov06_1;
    }
    ...
    private void INSERT_CHEQUE_FORMULAR()
    {
      ...
      for (int index = 0; index < 36; ++index)
      {
        ...
        {
          flag = true;
          ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["ChequeNo" + (index + 1).ToString()].Text = "\"" + this.sChequeNo[index] + "\"";
          ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["Cheque" + (index + 1).ToString()].Text = "\"" + this.sCheque[index].ToString("F2") + "\"";
        }
      }
      if (!flag)
        return;
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["ChequeDetail"].Text = "\"Online Details..\"";
    }
    ...
    public gsales_MTD_Nov06 Check_Report_Individual(
      string para_ToCheck_StartDate,
      string para_ToCheck_EndDate,
      string para_ReportType,
      string para_ReportTitle)
    ...
    {
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TExtra"].Text = "\"" + Convert.ToInt16(this.TExtra).ToString() + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TLoss"].Text = "\"" + Convert.ToInt16(this.TLoss).ToString() + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TReserve"].Text = "\"" + Convert.ToInt16(this.TReserve).ToString() + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TCancelCard"].Text = "\"" + Convert.ToInt16(this.TCancelCard).ToString() + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TCancelReserve"].Text = "\"" + Convert.ToInt16(this.TCancelReserve).ToString() + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TNormalIssue"].Text = "\"" + Convert.ToInt16(this.TNormalIssue).ToString() + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TAll"].Text = "\"" + Convert.ToInt16(this.TAll).ToString() + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TReplacement"].Text = "\"" + this.TReplacement.ToString() + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TDeposit"].Text = "\"" + this.TDeposit.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TBond"].Text = "\"" + this.TBond.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TExtraReceived"].Text = "\"" + this.TExtraReceived.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TRentalReceived"].Text = "\"" + this.TRentalReceived.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TDepositRefund"].Text = "\"" + this.TDepositRefund.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TBondRefund"].Text = "\"" + this.TBondRefund.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TBankInReceived"].Text = "\"" + this.TBankInReceived.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TBondReceived"].Text = "\"" + this.TBondReceived.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["GSTAmount"].Text = "\"" + this.GSTAmount.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TKeyDeposit"].Text = "\"" + this.sKeyDeposit.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TAdvancedReceived"].Text = "\"" + this.sAdvancedPayment.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TSalesReceived"].Text = "\"" + this.sTLastPayment.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TotalError"].Text = "\"" + this.sTError.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TErrorAdjust"].Text = "\"" + this.sTErrAmount.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TotalActualFunds"].Text = "\"" + this.sTotalActualFunds.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["GSTAdjust"].Text = "\"" + this.sGSTAdjust.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["GST"].Text = "\"" + this.sGST.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TBondAdjust"].Text = "\"" + this.sTBondErrAmount.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TActualBond"].Text = "\"" + this.sTActualBond.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TSalesGST"].Text = "\"" + this.sTSalesGST.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["ActualGST"].Text = "\"" + this.sActualGST.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["ActualTotal"].Text = "\"" + this.sActualTotal.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["ManagementFee"].Text = "\"" + this.sManagementFee.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["OtherFee"].Text = "\"" + this.sOtherFee.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TCheque"].Text = "\"" + this.TCheque.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TCash"].Text = "\"" + this.TCash.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TBanking"].Text = "\"" + this.TBanking.ToString("F2") + "\"";
      this.TAccManagerShouldPay = this.sActualTotal - (this.sManagementFee + this.sOtherFee) - this.sTActualBond;
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["sTReceivedAmountActual"].Text = "\"" + this.sTReceivedAmountActual.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TAccManagerShouldPay"].Text = "\"" + this.TAccManagerShouldPay.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["sRTActualBond"].Text = "\"" + this.sTActualBond.ToString("F2") + "\"";
      ((ReportDocument) this.gsales_MTD_Nov06_1).DataDefinition.FormulaFields["TNonGSTwithoutBond"].Text = "\"" + this.TNonGSTwithoutBond.ToString("F2") + "\"";
    }
  }
}
