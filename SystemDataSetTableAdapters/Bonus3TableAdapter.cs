...
// Type: AMS.SystemDataSetTableAdapters.Bonus3TableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  public class Bonus3TableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public Bonus3TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `Bonus3` (`StayType`, `StayLength`, `BonusType`, `BonusLength`, `BonusStart`, `DateUpdate`, `Staff`) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT StayType, StayLength, BonusType, BonusLength, BonusStart, DateUpdate, Staff FROM Bonus3";
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(SystemDataSet.Bonus3DataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual SystemDataSet.Bonus3DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.Bonus3DataTable data = new SystemDataSet.Bonus3DataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SystemDataSet.Bonus3DataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "Bonus3");
    }
