...
// Type: AMS.SystemDataSetTableAdapters.Bonus6TableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  public class Bonus6TableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public Bonus6TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `Bonus6` (`StayType`, `StayLength`, `BonusType`, `BonusLength`, `BonusStart`, `DateUpdate`, `Staff`) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT StayType, StayLength, BonusType, BonusLength, BonusStart, DateUpdate, Staff FROM Bonus6";
    ...
    [DebuggerNonUserCode]
    public virtual int Fill(SystemDataSet.Bonus6DataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual SystemDataSet.Bonus6DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.Bonus6DataTable data = new SystemDataSet.Bonus6DataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SystemDataSet.Bonus6DataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "Bonus6");
    }
