...
// Type: AMS.SystemDataSetTableAdapters.SystemSet3TableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  [DataObject(true)]
  public class SystemSet3TableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public SystemSet3TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `SystemSet3` (`SystemID`, `Description`, `BuildingType`, `Comport`, `GSTRate`, `Bonus`, `CheckOutTime`, `MGraceDefault`, `WGraceDefault`, `DGraceDefault`, `StaffID`, `Update`, `HotelCode`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT SystemID, Description, BuildingType, Comport, GSTRate, Bonus, CheckOutTime, MGraceDefault, WGraceDefault, DGraceDefault, StaffID, [Update], HotelCode FROM SystemSet3";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(SystemDataSet.SystemSet3DataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual SystemDataSet.SystemSet3DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.SystemSet3DataTable data = new SystemDataSet.SystemSet3DataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SystemDataSet.SystemSet3DataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "SystemSet3");
    }
