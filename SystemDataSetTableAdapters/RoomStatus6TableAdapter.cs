...
// Type: AMS.SystemDataSetTableAdapters.RoomStatus6TableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  public class RoomStatus6TableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public RoomStatus6TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM RoomStatus6\r\nWHERE        (RoomNo = ?)";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `RoomStatus6` (`RoomNo`, `Status`, `Description`, `RoomType`, `ClientID`, `Condition`, `StartDate`, `EndDate`, `StaffID`, `Update`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, Status, Description, RoomType, ClientID, Condition, StartDate, EndDate, StaffID, [Update] FROM RoomStatus6";
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Fill(SystemDataSet.RoomStatus6DataTable dataTable)
    {
    ...
    public virtual SystemDataSet.RoomStatus6DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.RoomStatus6DataTable data = new SystemDataSet.RoomStatus6DataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(SystemDataSet.RoomStatus6DataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "RoomStatus6");
    }
