...
// Type: AMS.SystemDataSetTableAdapters.SystemSet5TableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  public class SystemSet5TableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public SystemSet5TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `SystemSet5` (`SystemID`, `Description`, `BuildingType`, `Comport`, `GSTRate`, `Bonus`, `CheckOutTime`, `MGraceDefault`, `WGraceDefault`, `DGraceDefault`, `StaffID`, `Update`, `HotelCode`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT SystemID, Description, BuildingType, Comport, GSTRate, Bonus, CheckOutTime, MGraceDefault, WGraceDefault, DGraceDefault, StaffID, [Update], HotelCode FROM SystemSet5";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(SystemDataSet.SystemSet5DataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual SystemDataSet.SystemSet5DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.SystemSet5DataTable data = new SystemDataSet.SystemSet5DataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(SystemDataSet.SystemSet5DataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "SystemSet5");
    }
