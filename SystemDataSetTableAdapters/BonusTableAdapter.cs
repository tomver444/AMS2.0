...
// Type: AMS.SystemDataSetTableAdapters.BonusTableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  public class BonusTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public BonusTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `Bonus` (`StayType`, `StayLength`, `BonusType`, `BonusLength`, `BonusStart`, `DateUpdate`, `Staff`) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT StayType, StayLength, BonusType, BonusLength, BonusStart, DateUpdate, Staff FROM Bonus";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(SystemDataSet.BonusDataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual SystemDataSet.BonusDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.BonusDataTable data = new SystemDataSet.BonusDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SystemDataSet.BonusDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "Bonus");
    }
