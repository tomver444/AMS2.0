...
// Type: AMS.SystemDataSetTableAdapters.ZoneTableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class ZoneTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public ZoneTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `Zone` (`ZoneNo`, `ZoneName`, `BuildingNo`, `StaffID`, `Update`) VALUES (?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT ZoneNo, ZoneName, BuildingNo, StaffID, [Update] FROM [Zone]";
    ...
    [DebuggerNonUserCode]
    public virtual int Fill(SystemDataSet.ZoneDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual SystemDataSet.ZoneDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.ZoneDataTable data = new SystemDataSet.ZoneDataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(SystemDataSet.ZoneDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "Zone");
    }
