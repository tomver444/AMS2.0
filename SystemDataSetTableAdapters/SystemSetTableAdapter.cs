...
// Type: AMS.SystemDataSetTableAdapters.SystemSetTableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  public class SystemSetTableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public SystemSetTableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `SystemSet` (`SystemID`, `Description`, `BuildingType`, `Comport`, `GSTRate`, `Bonus`, `CheckOutTime`, `MGraceDefault`, `WGraceDefault`, `DGraceDefault`, `StaffID`, `Update`, `HotelCode`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT SystemID, Description, BuildingType, Comport, GSTRate, Bonus, CheckOutTime, MGraceDefault, WGraceDefault, DGraceDefault, StaffID, [Update], HotelCode FROM SystemSet";
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(SystemDataSet.SystemSetDataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual SystemDataSet.SystemSetDataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.SystemSetDataTable data = new SystemDataSet.SystemSetDataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SystemDataSet.SystemSetDataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "SystemSet");
    }
