...
// Type: AMS.SystemDataSetTableAdapters.SystemSet2TableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class SystemSet2TableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public SystemSet2TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `SystemSet2` (`SystemID`, `Description`, `BuildingType`, `Comport`, `GSTRate`, `Bonus`, `CheckOutTime`, `MGraceDefault`, `WGraceDefault`, `DGraceDefault`, `StaffID`, `Update`, `HotelCode`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT SystemID, Description, BuildingType, Comport, GSTRate, Bonus, CheckOutTime, MGraceDefault, WGraceDefault, DGraceDefault, StaffID, [Update], HotelCode FROM SystemSet2";
    ...
    [DebuggerNonUserCode]
    public virtual int Fill(SystemDataSet.SystemSet2DataTable dataTable)
    {
    ...
    public virtual SystemDataSet.SystemSet2DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.SystemSet2DataTable data = new SystemDataSet.SystemSet2DataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(SystemDataSet.SystemSet2DataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "SystemSet2");
    }
