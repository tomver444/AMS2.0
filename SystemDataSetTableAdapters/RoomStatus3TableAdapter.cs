...
// Type: AMS.SystemDataSetTableAdapters.RoomStatus3TableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  [ToolboxItem(true)]
  public class RoomStatus3TableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public RoomStatus3TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM RoomStatus3\r\nWHERE        (RoomNo = ?)";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `RoomStatus3` (`RoomNo`, `Status`, `Description`, `RoomType`, `ClientID`, `Condition`, `StartDate`, `EndDate`, `StaffID`, `Update`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, Status, Description, RoomType, ClientID, Condition, StartDate, EndDate, StaffID, [Update] FROM RoomStatus3";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(SystemDataSet.RoomStatus3DataTable dataTable)
    {
    ...
    public virtual SystemDataSet.RoomStatus3DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.RoomStatus3DataTable data = new SystemDataSet.RoomStatus3DataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SystemDataSet.RoomStatus3DataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "RoomStatus3");
    }
