...
// Type: AMS.SystemDataSetTableAdapters.SystemSet1TableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  public class SystemSet1TableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public SystemSet1TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `SystemSet1` (`SystemID`, `Description`, `BuildingType`, `Comport`, `GSTRate`, `Bonus`, `CheckOutTime`, `MGraceDefault`, `WGraceDefault`, `DGraceDefault`, `StaffID`, `Update`, `HotelCode`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT SystemID, Description, BuildingType, Comport, GSTRate, Bonus, CheckOutTime, MGraceDefault, WGraceDefault, DGraceDefault, StaffID, [Update], HotelCode FROM SystemSet1";
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Fill(SystemDataSet.SystemSet1DataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual SystemDataSet.SystemSet1DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.SystemSet1DataTable data = new SystemDataSet.SystemSet1DataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(SystemDataSet.SystemSet1DataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "SystemSet1");
    }
