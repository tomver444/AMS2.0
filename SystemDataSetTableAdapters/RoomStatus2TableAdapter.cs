...
// Type: AMS.SystemDataSetTableAdapters.RoomStatus2TableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  public class RoomStatus2TableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public RoomStatus2TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM RoomStatus2\r\nWHERE        (RoomNo = ?)";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `RoomStatus2` (`RoomNo`, `Status`, `Description`, `RoomType`, `ClientID`, `Condition`, `StartDate`, `EndDate`, `StaffID`, `Update`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, Status, Description, RoomType, ClientID, Condition, StartDate, EndDate, StaffID, [Update] FROM RoomStatus2";
    ...
    public virtual int Fill(SystemDataSet.RoomStatus2DataTable dataTable)
    {
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual SystemDataSet.RoomStatus2DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.RoomStatus2DataTable data = new SystemDataSet.RoomStatus2DataTable();
    ...
    [HelpKeyword("vs.data.TableAdapter")]
    [DebuggerNonUserCode]
    public virtual int Update(SystemDataSet.RoomStatus2DataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "RoomStatus2");
    }
