...
// Type: AMS.SystemDataSetTableAdapters.RoomStatus4TableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  public class RoomStatus4TableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public RoomStatus4TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.DeleteCommand.CommandText = "DELETE FROM RoomStatus4\r\nWHERE        (RoomNo = ?)";
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `RoomStatus4` (`RoomNo`, `Status`, `Description`, `RoomType`, `ClientID`, `Condition`, `StartDate`, `EndDate`, `StaffID`, `Update`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT RoomNo, Status, Description, RoomType, ClientID, Condition, StartDate, EndDate, StaffID, [Update] FROM RoomStatus4";
    ...
    [DebuggerNonUserCode]
    public virtual int Fill(SystemDataSet.RoomStatus4DataTable dataTable)
    {
    ...
    public virtual SystemDataSet.RoomStatus4DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.RoomStatus4DataTable data = new SystemDataSet.RoomStatus4DataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SystemDataSet.RoomStatus4DataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "RoomStatus4");
    }
