...
// Type: AMS.SystemDataSetTableAdapters.Bonus1TableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  public class Bonus1TableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public Bonus1TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `Bonus1` (`StayType`, `StayLength`, `BonusType`, `BonusLength`, `BonusStart`, `DateUpdate`, `Staff`) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT StayType, StayLength, BonusType, BonusLength, BonusStart, DateUpdate, Staff FROM Bonus1";
    ...
    public virtual int Fill(SystemDataSet.Bonus1DataTable dataTable)
    {
    ...
    public virtual SystemDataSet.Bonus1DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.Bonus1DataTable data = new SystemDataSet.Bonus1DataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SystemDataSet.Bonus1DataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "Bonus1");
    }
