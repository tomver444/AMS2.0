...
// Type: AMS.SystemDataSetTableAdapters.Bonus5TableAdapter
...
namespace AMS.SystemDataSetTableAdapters
{
  ...
  public class Bonus5TableAdapter : Component
  {
    ...
    [DebuggerNonUserCode]
    public Bonus5TableAdapter() => this.ClearBeforeFill = true;
    ...
    private void InitAdapter()
    {
      ...
      this._adapter.InsertCommand.CommandText = "INSERT INTO `Bonus5` (`StayType`, `StayLength`, `BonusType`, `BonusLength`, `BonusStart`, `DateUpdate`, `Staff`) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    private void InitCommandCollection()
    {
      ...
      this._commandCollection[0].CommandText = "SELECT StayType, StayLength, BonusType, BonusLength, BonusStart, DateUpdate, Staff FROM Bonus5";
    ...
    [DebuggerNonUserCode]
    public virtual int Fill(SystemDataSet.Bonus5DataTable dataTable)
    {
    ...
    [DebuggerNonUserCode]
    public virtual SystemDataSet.Bonus5DataTable GetData()
    {
      this.Adapter.SelectCommand = this.CommandCollection[0];
      SystemDataSet.Bonus5DataTable data = new SystemDataSet.Bonus5DataTable();
    ...
    [DebuggerNonUserCode]
    [HelpKeyword("vs.data.TableAdapter")]
    public virtual int Update(SystemDataSet.Bonus5DataTable dataTable)
    {
    ...
    {
      return this.Adapter.Update((DataSet) dataSet, "Bonus5");
    }
