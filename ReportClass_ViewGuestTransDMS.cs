...
// Type: AMS.ReportClass_ViewGuestTransDMS
...
namespace AMS
{
  internal class ReportClass_ViewGuestTransDMS
  {
    ...
    public ReportClass_ViewGuestTransDMS()
    {
      ...
      string para_BuildingNo)
    {
      ...
      object obj;
      switch (para_sTransCode)
      {
        case "T":
        case "TL":
          obj = (object) this.Check_Report_TransCode_T_n_TL(para_iTransID, para_BuildingNo);
          break;
        case "RC":
          obj = (object) this.Check_Report_TransCode_RC(para_iTransID, para_BuildingNo);
          break;
        case "R":
          obj = (object) this.Check_Report_TransCode_R(para_iTransID, para_BuildingNo);
          break;
        default:
          obj = (object) this.Check_Report_TransCode_OTHER_TRANSTYPE(para_iTransID, para_BuildingNo);
          break;
      }
      return obj;
    }
    ...
    private receipt2_shl Check_Report_TransCode_T_n_TL(int para_iTransID, string para_BuildingNo)
    {
      ((ReportDocument) this.receipt2_1).SetDataSource(this.db.temp_DB.tempDataSet.Receipt.DataSet);
      ...
      if (ReportClass_ViewGuestTransDMS.Temp_MDB_SaveFlag)
      ...
      localCommand.CommandText = localCommand.CommandText + "Select CardTrans.TransID,CardTrans.ClientID,Client.ForeName,Client.SurName,CardTrans.CardNo,CardTrans.OldRoom,CardTrans.ReserveRef,CardTrans.RoomNo,CardTrans.Condition,CardTrans.PreviousAdvance,CardTrans.AdvancedPayment,CardTrans.Balance,CardTrans.Bond,CardTrans.RBA,CardTrans.Deposit,CardTrans.KeyDeposit,CardTrans.ExtraCharge,CardTrans.ExDescription,CardTrans.RoomCharge,CardTrans.TransType,CardTrans.TransDate,CardTrans.TransTime,CardTrans.ValidStart,CardTrans.ValidEnd,CardTrans.CheckInDate,CardTrans.ChargeType,CardTrans.BonusClaim,CardTrans.GST,CardTrans.LastPayment,CardTrans.StaffID From ( CardTrans INNER JOIN Client ON CardTrans.ClientID=Client.ClientID) Where (((CardTrans.TransID)=" + (object) para_iTransID + "))";
      ...
      ((ReportDocument) this.receipt2_1).DataDefinition.FormulaFields[0].Text = "\"" + ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.gDescription + "\"";
      ((ReportDocument) this.receipt2_1).DataDefinition.FormulaFields[1].Text = "\"" + ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.gBuildingName + "\"";
      ((ReportDocument) this.receipt2_1).DataDefinition.FormulaFields["StaffName"].Text = "\"" + this.sStaffName + "\"";
      this.FORMULAR_ASSIGNMENT_receipt2((ReportClass) this.receipt2_1);
      this.Check_ExtraCharge_Details((ReportClass) this.receipt2_1);
      return this.receipt2_1;
    }

    private void FORMULAR_ASSIGNMENT_receipt2(ReportClass para_ReportClass_receipt2)
    {
      try
      {
        if (Convert.ToDecimal(this.sDepositRpt) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[3].Text = "\"" + this.sName1 + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[9].Text = "\"" + Convert.ToDecimal(this.sDepositRpt).ToString() + "\"";
        }
        else
        {
          this.sName1 = "";
          this.sDepositRpt = "";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[3].Text = "\"" + this.sName1 + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[9].Text = "\"" + this.sDepositRpt + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (Convert.ToDecimal(this.sBond) != 0M)
        {
          ...
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[4].Text = "\"" + this.sName2 + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[10].Text = "\"" + Convert.ToDecimal(this.sBond).ToString() + "\"";
        }
        else if (Convert.ToDecimal(this.sRBA) != 0M)
        {
          this.sName2 = "Bond to Refund By RTBA";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[4].Text = "\"" + this.sName2 + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[10].Text = "\"" + Convert.ToDecimal(this.sRBA).ToString() + "\"";
        }
        else
        {
          this.sName2 = "";
          this.sRBA = "";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[4].Text = "\"" + this.sName2 + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[10].Text = "\"" + this.sRBA + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        ...
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[12].Text = "\"" + Convert.ToDecimal(this.sExtraCharge).ToString() + "\"";
          if (this.sExDescription != "")
            ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[16].Text = "\"" + this.sExDescription + "\"";
        }
        else
        {
          this.sExtraCharge = "";
          this.sExDescription = "";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[12].Text = "\"" + this.sExtraCharge + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[16].Text = "\"" + this.sExDescription + "\"";
        }
      }
      catch
      ...
      try
      {
        ...
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[6].Text = "\"" + this.sName5 + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[13].Text = "\"" + Convert.ToDecimal(this.sRoomCharge).ToString() + "\"";
        }
        else
        {
          this.sName5 = "";
          this.sRoomCharge = "";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[6].Text = "\"" + this.sName5 + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[13].Text = "\"" + this.sRoomCharge + "\"";
        }
...
label_28:
      try
      {
        ...
        if (Convert.ToDecimal(this.sPrevBalanceAmount) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[42].Text = "\"" + this.sPrevBalance + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[41].Text = "\"" + (-Convert.ToDecimal(this.sPrevBalanceAmount)).ToString() + "\"";
        }
        else
        {
          this.sPrevBalance = "";
          this.sPrevBalanceAmount = "";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[42].Text = "\"" + this.sPrevBalance + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[41].Text = "\"" + this.sPrevBalanceAmount + "\"";
        }
      }
      catch
      {
...
label_34:
      try
      {
        if (this.sTransCode == "T" || this.sTransCode == "TL")
        {
          if (Convert.ToDecimal(this.sPrevAdvanceAmount) != 0M)
          {
            ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[39].Text = "\"" + this.sPrevAdvance + "\"";
            ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[40].Text = "\"" + (-Convert.ToDecimal(this.sPrevAdvanceAmount)).ToString() + "\"";
          }
          else
          {
            this.sPrevAdvance = "";
            this.sPrevAdvanceAmount = "";
            ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[39].Text = "\"" + this.sPrevAdvance + "\"";
            ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[40].Text = "\"" + this.sPrevAdvanceAmount + "\"";
          }
        }
        else if (Convert.ToDecimal(this.sPrevAdvanceAmount) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[39].Text = "\"" + this.sPrevAdvance + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[40].Text = "\"" + Convert.ToDecimal(this.sPrevAdvanceAmount).ToString() + "\"";
        }
      ...
      try
      {
        if (Convert.ToDecimal(this.sBalanceAdvance) > 0M)
        {
          ...
          {
            ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[8].Text = "\"" + this.sName6 + "\"";
            ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[15].Text = "\"" + Convert.ToDecimal(this.sBalanceAdvance).ToString() + "\"";
          }
          else
          {
            this.sName6 = "";
            ...
            ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[8].Text = "\"" + this.sName6 + "\"";
            ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[15].Text = "\"" + this.sBalanceAdvance + "\"";
          }
        }
      }
      catch
      ...
      try
      {
        ...
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[14].Text = "\"" + Convert.ToDecimal(this.sTotalPaidRpt).ToString() + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[25].Text = "\"" + this.sTotalPaidDesc + "\"";
          this.sLine3 = "=============";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[38].Text = "\"" + this.sLine3 + "\"";
        }
        else
        {
          this.sTotalPaidRpt = "";
          this.sTotalPaidDesc = "";
          this.sLine3 = "";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[14].Text = "\"" + this.sTotalPaidRpt + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[25].Text = "\"" + this.sTotalPaidDesc + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[38].Text = "\"" + this.sLine3 + "\"";
        }
      }
      ...
      try
      {
        ...
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[7].Text = "\"" + Convert.ToDecimal(this.sTransGST).ToString() + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[17].Text = "\"" + this.GSTDisplay + "\"";
        }
        else
        {
          this.sTransGST = "";
          this.GSTDisplay = "";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[7].Text = "\"" + this.sTransGST + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[17].Text = "\"" + this.GSTDisplay + "\"";
        }
      }
      catch
      ...
      try
      {
        if (this.sChargeType != "")
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields["ChargeType"].Text = "\"" + this.sChargeType + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields["ChargeTypeDesc"].Text = "\"" + this.sChargeTypeDesc + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields["ChargeTypeColon"].Text = "\"" + this.sName7 + "\"";
        }
        else
        {
          this.sChargeType = "";
      ...
      try
      {
        ...
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[19].Text = "\"" + this.sCheckInDate + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[21].Text = "\"" + this.sCheckInDateDesc + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[23].Text = "\"" + this.sName8 + "\"";
        }
        else
        {
          this.sCheckInDate = "";
      ...
      try
      {
        if (Convert.ToDecimal(this.sAmountDueRpt) != 0M)
        {
          ...
          this.sLine2 = "______________";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[24].Text = "\"" + this.sAmountDueDesc + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[2].Text = "\"" + Convert.ToDecimal(this.sAmountDueRpt).ToString() + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[36].Text = "\"" + this.sLine1 + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[37].Text = "\"" + this.sLine2 + "\"";
        }
        else
        {
          this.sAmountDueRpt = "";
      ...
      try
      {
        ...
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[26].Text = "\"" + this.sKeyName + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[27].Text = "\"" + Convert.ToDecimal(this.sKeyDepositRpt).ToString() + "\"";
        }
        else
        {
          this.sKeyName = "";
          this.sKeyDepositRpt = "";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[26].Text = "\"" + this.sKeyName + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[27].Text = "\"" + this.sKeyDepositRpt + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (Convert.ToDecimal(this.sCurrentAmount) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[28].Text = "\"" + this.sRoomStartDays + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[29].Text = "\"" + Convert.ToDecimal(this.sCurrentAmount).ToString() + "\"";
        }
        else
        {
          this.sRoomStartDays = "";
          this.sCurrentAmount = "";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[28].Text = "\"" + this.sRoomStartDays + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[29].Text = "\"" + this.sCurrentAmount + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (Convert.ToDecimal(this.sMiddleAmount) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[32].Text = "\"" + this.sTotal + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[33].Text = "\"" + Convert.ToDecimal(this.sMiddleAmount).ToString() + "\"";
        }
        else
        {
          this.sTotal = "";
          this.sMiddleAmount = "";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[32].Text = "\"" + this.sTotal + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[33].Text = "\"" + this.sMiddleAmount + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (Convert.ToDecimal(this.sLastAmount) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[30].Text = "\"" + this.sRoomEndDays + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[31].Text = "\"" + Convert.ToDecimal(this.sLastAmount).ToString() + "\"";
        }
        else
        {
          this.sRoomEndDays = "";
          this.sLastAmount = "";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[30].Text = "\"" + this.sRoomEndDays + "\"";
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[31].Text = "\"" + this.sLastAmount + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (this.sTransDesc != "")
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[34].Text = "\"" + this.sTransDesc + "\"";
        }
        else
        {
          this.sTransDesc = "";
      ...
      try
      {
        if (this.sOldRoomNo != "")
        {
          if (this.sTransDesc == "Reservation")
          {
            ...
            ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[58].Text = "\"" + this.sOldRoomName + "\"";
            ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[59].Text = "\"" + this.sOldRoomNo + "\"";
          }
        }
      }
      catch
      ...
      try
      {
        ...
        {
          ((ReportDocument) para_ReportClass_receipt2).DataDefinition.FormulaFields[57].Text = "\"" + this.sCondition + "\"";
        }
        else
        {
          this.sCondition = "";
...
label_28:
    ...
    private paymentnote Check_Report_TransCode_R(int para_iTransID, string para_BuildingNo)
    {
      ((ReportDocument) this.paymentnote_1).SetDataSource(this.db.temp_DB.tempDataSet.Receipt.DataSet);
      this.db.Local_Command.CommandText = "Delete * from Receipt";
      this.db.Local_Command.Connection = this.db.temp_DB.receiptTableAdapter.Connection;
      this.db.Local_Command.Connection.Open();
      this.db.Local_Command.ExecuteNonQuery();
      ...
      this.CHECK_NULL(para_BuildingNo);
      this.TOTAL_AMOUNTDUE();
      ((ReportDocument) this.paymentnote_1).DataDefinition.FormulaFields[0].Text = "\"" + ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.gDescription + "\"";
      ((ReportDocument) this.paymentnote_1).DataDefinition.FormulaFields[1].Text = "\"" + ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.gBuildingName + "\"";
      ((ReportDocument) this.paymentnote_1).DataDefinition.FormulaFields["StaffName"].Text = "\"" + this.sStaffName + "\"";
      this.FORMULAR_ASSIGNMENT_paymentnote((ReportClass) this.paymentnote_1);
      this.Check_ExtraCharge_Details((ReportClass) this.paymentnote_1);
      return this.paymentnote_1;
    }

    private void FORMULAR_ASSIGNMENT_paymentnote(ReportClass para_ReportClass_paymentnote)
    {
      try
      {
        if (Convert.ToDecimal(this.sDepositRpt) != 0M)
        {
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[3].Text = "\"" + this.sName1 + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[10].Text = "\"" + Convert.ToDecimal(this.sDepositRpt).ToString() + "\"";
        }
        else
        {
          this.sName1 = "";
          this.sDepositRpt = "";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[3].Text = "\"" + this.sName1 + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[10].Text = "\"" + this.sDepositRpt + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (Convert.ToDecimal(this.sBond) != 0M)
        {
          if (Convert.ToDecimal(this.sBond) > 0M)
            ...
            this.sName2 = this.sTransCode == "E" || this.sTransCode == "EL" || this.sTransCode == "NE" ? "Bond Reduce" : "Bond Refund";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[4].Text = "\"" + this.sName2 + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[11].Text = "\"" + Convert.ToDecimal(this.sBond).ToString() + "\"";
        }
        else if (Convert.ToDecimal(this.sRBA) != 0M)
        {
          this.sName2 = "Bond to Refund By RTBA";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[4].Text = "\"" + this.sName2 + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[11].Text = "\"" + Convert.ToDecimal(this.sRBA).ToString() + "\"";
        }
        else
        {
          this.sName2 = "";
          this.sRBA = "";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[4].Text = "\"" + this.sName2 + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[11].Text = "\"" + this.sRBA + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (Convert.ToDecimal(this.sExtraCharge) != 0M)
        {
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[13].Text = "\"" + Convert.ToDecimal(this.sExtraCharge).ToString() + "\"";
          if (this.sExDescription != "")
            ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[17].Text = "\"" + this.sExDescription + "\"";
        }
        else
        {
          this.sExtraCharge = "";
          this.sExDescription = "";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[13].Text = "\"" + this.sExtraCharge + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[17].Text = "\"" + this.sExDescription + "\"";
        }
      }
      catch
      ...
      try
      {
        ...
        if (Convert.ToDecimal(this.sRoomCharge) > 0M)
        {
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[7].Text = "\"" + this.sName5 + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[14].Text = "\"" + Convert.ToDecimal(this.sRoomCharge).ToString() + "\"";
        }
        else
        {
          this.sName5 = "";
          this.sRoomCharge = "";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[7].Text = "\"" + this.sName5 + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[14].Text = "\"" + this.sRoomCharge + "\"";
        }
        if (Convert.ToDecimal(this.sRBA) != 0M)
        {
          this.sName2 = "Bond to Refund By RTBA";
...
label_28:
      try
      {
        if (Convert.ToDecimal(this.sBalanceAdvance) > 0M)
        {
          if (!(this.sTotalPaidRpt == "0") || !(this.sPrevAdvanceAmount == this.sBalanceAdvance))
          {
            ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[9].Text = "\"" + this.sName6 + "\"";
            ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[16].Text = "\"" + Convert.ToDecimal(this.sBalanceAdvance).ToString() + "\"";
          }
          else
          {
            this.sName6 = "";
            this.sBalanceAdvance = "";
            ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[9].Text = "\"" + this.sName6 + "\"";
            ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[16].Text = "\"" + this.sBalanceAdvance + "\"";
          }
        }
      }
      catch
      ...
      try
      {
        if (Convert.ToDecimal(this.sTotalPaidRpt) != 0M)
        {
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[15].Text = "\"" + Convert.ToDecimal(this.sTotalPaidRpt).ToString() + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[26].Text = "\"" + this.sTotalPaidDesc + "\"";
          this.sLine3 = "=============";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[35].Text = "\"" + this.sLine3 + "\"";
        }
        else
        {
          this.sTotalPaidRpt = "";
          this.sTotalPaidDesc = "";
          this.sLine3 = "";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[15].Text = "\"" + this.sTotalPaidRpt + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[26].Text = "\"" + this.sTotalPaidDesc + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[35].Text = "\"" + this.sLine3 + "\"";
        }
      }
      ...
      try
      {
        if (Convert.ToDecimal(this.sTransGST) > 0M)
        {
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[8].Text = "\"" + Convert.ToDecimal(this.sTransGST).ToString() + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[18].Text = "\"" + this.GSTDisplay + "\"";
        }
        else
        {
          this.sTransGST = "";
          this.GSTDisplay = "";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[8].Text = "\"" + this.sTransGST + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[18].Text = "\"" + this.GSTDisplay + "\"";
        }
      }
      catch
      ...
      try
      {
        if (this.sChargeType != "")
        {
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields["ChargeType"].Text = "\"" + this.sChargeType + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields["ChargeTypeDesc"].Text = "\"" + this.sChargeTypeDesc + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields["ChargeTypeColon"].Text = "\"" + this.sName7 + "\"";
        }
        else
        {
          this.sChargeType = "";
      ...
      try
      {
        if (this.sCheckInDate != "")
        {
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[20].Text = "\"" + this.sCheckInDate + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[22].Text = "\"" + this.sCheckInDateDesc + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[24].Text = "\"" + this.sName8 + "\"";
        }
        else
        {
          this.sCheckInDate = "";
      ...
      try
      {
        if (Convert.ToDecimal(this.sAmountDueRpt) != 0M)
        {
          this.sLine1 = "______________";
          this.sLine2 = "______________";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[25].Text = "\"" + this.sAmountDueDesc + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[2].Text = "\"" + Convert.ToDecimal(this.sAmountDueRpt).ToString() + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[33].Text = "\"" + this.sLine1 + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[34].Text = "\"" + this.sLine2 + "\"";
        }
        else
        {
          this.sAmountDueRpt = "";
      ...
      try
      {
        if (Convert.ToDecimal(this.sKeyDepositRpt) != 0M)
        {
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[27].Text = "\"" + this.sKeyName + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[28].Text = "\"" + Convert.ToDecimal(this.sKeyDepositRpt).ToString() + "\"";
        }
        else
        {
          this.sKeyName = "";
          this.sKeyDepositRpt = "";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[27].Text = "\"" + this.sKeyName + "\"";
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[28].Text = "\"" + this.sKeyDepositRpt + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (this.sTransDesc != "")
        {
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[30].Text = "\"" + this.sTransDesc + "\"";
        }
        else
        {
          this.sTransDesc = "";
      ...
      try
      {
        if (this.sOldRoomNo != "")
        {
          ...
          {
            this.sOldRoomName = "Previous Reserved Room No.";
            ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[32].Text = "\"" + this.sOldRoomName + "\"";
            ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[31].Text = "\"" + this.sOldRoomNo + "\"";
          }
        }
      }
      catch
      ...
      try
      {
        if (this.sCondition.Contains("Unit"))
        {
          ((ReportDocument) para_ReportClass_paymentnote).DataDefinition.FormulaFields[36].Text = "\"" + this.sCondition + "\"";
        }
        else
        {
          this.sCondition = "";
    ...
    private receipt1_shl Check_Report_TransCode_OTHER_TRANSTYPE(
      int para_iTransID,
      string para_BuildingNo)
    {
      ((ReportDocument) this.receipt1_1).SetDataSource(this.db.temp_DB.tempDataSet.Receipt.DataSet);
      this.db.Local_Command.CommandText = "Delete * from Receipt";
      this.db.Local_Command.Connection = this.db.temp_DB.receiptTableAdapter.Connection;
      this.db.Local_Command.Connection.Open();
      this.db.Local_Command.ExecuteNonQuery();
      ...
      this.CHECK_NULL(para_BuildingNo);
      this.TOTAL_AMOUNTDUE();
      ((ReportDocument) this.receipt1_1).DataDefinition.FormulaFields[0].Text = "\"" + ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.gDescription + "\"";
      ((ReportDocument) this.receipt1_1).DataDefinition.FormulaFields[1].Text = "\"" + ModDoorLockSystem.Class_ModDoorLockSystem_Object_Ptr.gBuildingName + "\"";
      ((ReportDocument) this.receipt1_1).DataDefinition.FormulaFields["StaffName"].Text = "\"" + this.sStaffName + "\"";
      this.FORMULAR_ASSIGNMENT_receipt1((ReportClass) this.receipt1_1);
      this.Check_ExtraCharge_Details((ReportClass) this.receipt1_1);
      return this.receipt1_1;
    }
    ...
    private void FORMULAR_ASSIGNMENT_receipt1(ReportClass para_ReportClass_receipt1)
    {
      try
      {
        if (Convert.ToDecimal(this.sDepositRpt) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[3].Text = "\"" + this.sName1 + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[9].Text = "\"" + Convert.ToDecimal(this.sDepositRpt).ToString() + "\"";
        }
        else
        {
          this.sName1 = "";
          this.sDepositRpt = "";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[3].Text = "\"" + this.sName1 + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[9].Text = "\"" + this.sDepositRpt + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (Convert.ToDecimal(this.sBond) != 0M)
        {
          if (Convert.ToDecimal(this.sBond) > 0M)
            ...
            this.sName2 = this.sTransCode == "E" || this.sTransCode == "EL" || this.sTransCode == "NE" ? "Bond Reduce" : "Bond Refund";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[4].Text = "\"" + this.sName2 + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[10].Text = "\"" + Convert.ToDecimal(this.sBond).ToString() + "\"";
        }
        else if (Convert.ToDecimal(this.sRBA) != 0M)
        {
          this.sName2 = "Bond to Refund By RTBA";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[4].Text = "\"" + this.sName2 + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[10].Text = "\"" + Convert.ToDecimal(this.sRBA).ToString() + "\"";
        }
        else
        {
          this.sName2 = "";
          this.sRBA = "";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[4].Text = "\"" + this.sName2 + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[10].Text = "\"" + this.sRBA + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (Convert.ToDecimal(this.sExtraCharge) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[12].Text = "\"" + Convert.ToDecimal(this.sExtraCharge).ToString() + "\"";
          if (this.sExDescription != "")
            ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[16].Text = "\"" + this.sExDescription + "\"";
        }
        else
        {
          this.sExtraCharge = "";
          this.sExDescription = "";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[12].Text = "\"" + this.sExtraCharge + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[16].Text = "\"" + this.sExDescription + "\"";
        }
      }
      catch
      ...
      try
      {
        ...
        if (Convert.ToDecimal(this.sRoomCharge) > 0M)
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[6].Text = "\"" + this.sName5 + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[13].Text = "\"" + Convert.ToDecimal(this.sRoomCharge).ToString() + "\"";
        }
        else
        {
          this.sName5 = "";
          this.sRoomCharge = "";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[6].Text = "\"" + this.sName5 + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[13].Text = "\"" + this.sRoomCharge + "\"";
        }
        if (Convert.ToDecimal(this.sRBA) != 0M)
        {
          this.sName2 = "Bond to Refund By RTBA";
...
label_28:
      try
      {
        ...
        if (Convert.ToDecimal(this.sPrevBalanceAmount) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[57].Text = "\"" + this.sPrevBalance + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[58].Text = "\"" + (-Convert.ToDecimal(this.sPrevBalanceAmount)).ToString() + "\"";
        }
        else
        {
          this.sPrevBalance = "";
          this.sPrevBalanceAmount = "";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[57].Text = "\"" + this.sPrevBalance + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[58].Text = "\"" + this.sPrevBalanceAmount + "\"";
        }
      }
      catch
      {
...
label_34:
      try
      {
        if (this.sTransCode == "T" || this.sTransCode == "TL")
        {
          if (Convert.ToDecimal(this.sPrevAdvanceAmount) != 0M)
          {
            ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[39].Text = "\"" + this.sPrevAdvance + "\"";
            ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[40].Text = "\"" + (-Convert.ToDecimal(this.sPrevAdvanceAmount)).ToString() + "\"";
          }
          else
          {
            this.sPrevAdvance = "";
            this.sPrevAdvanceAmount = "";
            ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[39].Text = "\"" + this.sPrevAdvance + "\"";
            ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[40].Text = "\"" + this.sPrevAdvanceAmount + "\"";
          }
        }
        else if (Convert.ToDecimal(this.sPrevAdvanceAmount) != 0M)
        {
      ...
      try
      {
        if (Convert.ToDecimal(this.sBalanceAdvance) > 0M)
        {
          if (!(this.sTotalPaidRpt == "0") || !(this.sPrevAdvanceAmount == this.sBalanceAdvance))
          {
            ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[8].Text = "\"" + this.sName6 + "\"";
            ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[15].Text = "\"" + Convert.ToDecimal(this.sBalanceAdvance).ToString() + "\"";
          }
          else
          {
            this.sName6 = "";
            this.sBalanceAdvance = "";
            ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[8].Text = "\"" + this.sName6 + "\"";
            ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[15].Text = "\"" + this.sBalanceAdvance + "\"";
          }
        }
      }
      catch
      ...
      try
      {
        if (Convert.ToDecimal(this.sTotalPaidRpt) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[14].Text = "\"" + Convert.ToDecimal(this.sTotalPaidRpt).ToString() + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[25].Text = "\"" + this.sTotalPaidDesc + "\"";
          this.sLine3 = "=============";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[38].Text = "\"" + this.sLine3 + "\"";
        }
        else
        {
          this.sTotalPaidRpt = "";
          this.sTotalPaidDesc = "";
          this.sLine3 = "";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[14].Text = "\"" + this.sTotalPaidRpt + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[25].Text = "\"" + this.sTotalPaidDesc + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[38].Text = "\"" + this.sLine3 + "\"";
        }
      }
      ...
      try
      {
        if (Convert.ToDecimal(this.sTransGST) > 0M)
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[7].Text = "\"" + Convert.ToDecimal(this.sTransGST).ToString() + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[17].Text = "\"" + this.GSTDisplay + "\"";
        }
        else
        {
          this.sTransGST = "";
          this.GSTDisplay = "";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[7].Text = "\"" + this.sTransGST + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[17].Text = "\"" + this.GSTDisplay + "\"";
        }
      }
      catch
      ...
      try
      {
        if (this.sChargeType != "")
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields["ChargeType"].Text = "\"" + this.sChargeType + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields["ChargeTypeDesc"].Text = "\"" + this.sChargeTypeDesc + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields["ChargeTypeColon"].Text = "\"" + this.sName7 + "\"";
        }
        else
        {
          this.sChargeType = "";
      ...
      try
      {
        if (this.sCheckInDate != "")
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[19].Text = "\"" + this.sCheckInDate + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[21].Text = "\"" + this.sCheckInDateDesc + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[23].Text = "\"" + this.sName8 + "\"";
        }
        else
        {
          this.sCheckInDate = "";
      ...
      try
      {
        if (Convert.ToDecimal(this.sAmountDueRpt) != 0M)
        {
          this.sLine1 = "______________";
          this.sLine2 = "______________";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[24].Text = "\"" + this.sAmountDueDesc + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[2].Text = "\"" + Convert.ToDecimal(this.sAmountDueRpt).ToString() + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[36].Text = "\"" + this.sLine1 + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[37].Text = "\"" + this.sLine2 + "\"";
        }
        else
        {
          this.sAmountDueRpt = "";
      ...
      try
      {
        if (Convert.ToDecimal(this.sKeyDepositRpt) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[26].Text = "\"" + this.sKeyName + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[27].Text = "\"" + Convert.ToDecimal(this.sKeyDepositRpt).ToString() + "\"";
        }
        else
        {
          this.sKeyName = "";
          this.sKeyDepositRpt = "";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[26].Text = "\"" + this.sKeyName + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[27].Text = "\"" + this.sKeyDepositRpt + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (Convert.ToDecimal(this.sCurrentAmount) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[28].Text = "\"" + this.sRoomStartDays + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[29].Text = "\"" + Convert.ToDecimal(this.sCurrentAmount).ToString() + "\"";
        }
        else
        {
          this.sRoomStartDays = "";
          this.sCurrentAmount = "";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[28].Text = "\"" + this.sRoomStartDays + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[29].Text = "\"" + this.sCurrentAmount + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (Convert.ToDecimal(this.sMiddleAmount) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[32].Text = "\"" + this.sTotal + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[33].Text = "\"" + Convert.ToDecimal(this.sMiddleAmount).ToString() + "\"";
        }
        else
        {
          this.sTotal = "";
          this.sMiddleAmount = "";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[32].Text = "\"" + this.sTotal + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[33].Text = "\"" + this.sMiddleAmount + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (Convert.ToDecimal(this.sLastAmount) != 0M)
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[30].Text = "\"" + this.sRoomEndDays + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[31].Text = "\"" + Convert.ToDecimal(this.sLastAmount).ToString() + "\"";
        }
        else
        {
          this.sRoomEndDays = "";
          this.sLastAmount = "";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[30].Text = "\"" + this.sRoomEndDays + "\"";
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[31].Text = "\"" + this.sLastAmount + "\"";
        }
      }
      catch
      {
      ...
      try
      {
        if (this.sTransDesc != "")
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[34].Text = "\"" + this.sTransDesc + "\"";
        }
        else
        {
          this.sTransDesc = "";
      ...
      try
      {
        if (this.sOldRoomNo != "")
        {
          ...
          {
            this.sOldRoomName = "Previous Reserved Room No.";
            ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[56].Text = "\"" + this.sOldRoomName + "\"";
            ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[55].Text = "\"" + this.sOldRoomNo + "\"";
          }
        }
      }
      catch
      ...
      try
      {
        if (this.sCondition.Contains("Unit"))
        {
          ((ReportDocument) para_ReportClass_receipt1).DataDefinition.FormulaFields[54].Text = "\"" + this.sCondition + "\"";
        }
        else
        {
          this.sCondition = "";
