...
// Type: AMS.ReportClass_Receipt_CancelGuest
...
namespace AMS
{
  internal class ReportClass_Receipt_CancelGuest
  {
    ...
    public ReportClass_Receipt_CancelGuest()
    {
      ...
      string para_BuildingNo)
    {
      ...
      return (object) this.Check_Report_TransCode_OTHER_TRANSTYPE(para_iTransID, para_BuildingNo);
    }
      ...
      string para_BuildingNo)
    {
      ...
      if (ReportClass_Receipt_CancelGuest.Temp_MDB_SaveFlag)
