...
// Type: AMS.ReportClass_Receipt_Reservation
...
namespace AMS
{
  internal class ReportClass_Receipt_Reservation
  {
    ...
    public ReportClass_Receipt_Reservation()
    {
      ...
      string para_BuildingNo)
    {
      ...
      return (object) this.Check_Report_TransCode_R(para_iTransID, para_BuildingNo);
    }
    ...
    private paymentnote Check_Report_TransCode_R(int para_iTransID, string para_BuildingNo)
    {
      ...
      if (ReportClass_Receipt_Reservation.Temp_MDB_SaveFlag)
