...
// Type: AMS.BankingDBDataSetTableAdapters.TableAdapterManager
...
namespace AMS.BankingDBDataSetTableAdapters
{
  ...
  public class TableAdapterManager : Component
  {
    ...
    private BankingTableAdapter _bankingTableAdapter;
    ...
    {
      get => this._bankingTableAdapter;
      set => this._bankingTableAdapter = value;
    }
    ...
    public IDbConnection Connection
    {
      get
      {
        ...
        return this._bankingTableAdapter != null && this._bankingTableAdapter.Connection != null ? (IDbConnection) this._bankingTableAdapter.Connection : (IDbConnection) null;
      }
    ...
    public int TableAdapterInstanceCount
    {
      get
      {
        ...
        if (this._bankingTableAdapter != null)
      ...
      List<DataRow> allAddedRows)
    {
      ...
      if (this._bankingTableAdapter != null)
      {
        DataRow[] realUpdatedRows = this.GetRealUpdatedRows(dataSet.Banking.Select((string) null, (string) null, DataViewRowState.ModifiedCurrent), allAddedRows);
        if (realUpdatedRows != null && 0 < realUpdatedRows.Length)
        {
          num += this._bankingTableAdapter.Update(realUpdatedRows);
    ...
    [DebuggerNonUserCode]
    private int UpdateInsertedRows(BankingDBDataSet dataSet, List<DataRow> allAddedRows)
    {
      int num = 0;
      if (this._bankingTableAdapter != null)
      {
        DataRow[] dataRowArray = dataSet.Banking.Select((string) null, (string) null, DataViewRowState.Added);
        if (dataRowArray != null && 0 < dataRowArray.Length)
        {
          num += this._bankingTableAdapter.Update(dataRowArray);
    ...
    [DebuggerNonUserCode]
    private int UpdateDeletedRows(BankingDBDataSet dataSet, List<DataRow> allChangedRows)
    {
      int num = 0;
      if (this._bankingTableAdapter != null)
      {
        DataRow[] dataRowArray = dataSet.Banking.Select((string) null, (string) null, DataViewRowState.Deleted);
        if (dataRowArray != null && 0 < dataRowArray.Length)
        {
          num += this._bankingTableAdapter.Update(dataRowArray);
    ...
    public virtual int UpdateAll(BankingDBDataSet dataSet)
    {
      ...
      if (!dataSet.HasChanges())
        return 0;
      if (this._bankingTableAdapter != null && !this.MatchTableAdapterConnection((IDbConnection) this._bankingTableAdapter.Connection))
      ...
      try
      {
        if (this._bankingTableAdapter != null)
        {
          dictionary.Add((object) this._bankingTableAdapter, (IDbConnection) this._bankingTableAdapter.Connection);
          this._bankingTableAdapter.Connection = (OleDbConnection) connection;
          this._bankingTableAdapter.Transaction = (OleDbTransaction) dbTransaction;
          if (this._bankingTableAdapter.Adapter.AcceptChangesDuringUpdate)
          {
            this._bankingTableAdapter.Adapter.AcceptChangesDuringUpdate = false;
            dataAdapterList.Add((DataAdapter) this._bankingTableAdapter.Adapter);
          }
        }
      ...
      finally
      {
        ...
        if (this._bankingTableAdapter != null)
        {
          this._bankingTableAdapter.Connection = (OleDbConnection) dictionary[(object) this._bankingTableAdapter];
          this._bankingTableAdapter.Transaction = (OleDbTransaction) null;
        }
