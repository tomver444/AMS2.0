...
// Type: AMS.ReportClass_Receipt_LastTrans
...
namespace AMS
{
  internal class ReportClass_Receipt_LastTrans
  {
    ...
    public ReportClass_Receipt_LastTrans()
    {
      ...
      string para_BuildingNo)
    {
      ...
      return para_sTransCode == "T" || para_sTransCode == "TL" ? (object) this.Check_Report_TransCode_T_n_TL(para_iTransID, para_BuildingNo) : (object) this.Check_Report_TransCode_OTHER_TRANSTYPE(para_iTransID, para_BuildingNo);
    }
    ...
    private receipt2_shl Check_Report_TransCode_T_n_TL(int para_iTransID, string para_BuildingNo)
    {
      ...
      if (ReportClass_Receipt_LastTrans.Temp_MDB_SaveFlag)
